...
#Region " Variables "
    ...
    Private m_listDIST_GuiasRemision As List(Of EDIST_GuiasTodas)
    Private m_dtDIST_GuiasRemision As DataTable

    Private m_dsDIST_GuiasRemision As DataSet
    Private d_dist_guiasremision As DDIST_GuiasTodas
...
#Region " Constructores "
    ...
    Public Sub New()
        d_dist_guiasremision = New DDIST_GuiasTodas()
    End Sub
...
#Region " Propiedades "
    ...
    Public Property ListDIST_GuiasRemision() As List(Of EDIST_GuiasTodas)
        Get
            Return m_listDIST_GuiasRemision
        End Get
        Set(ByVal value As List(Of EDIST_GuiasTodas))
...
#Region " Metodos "
    ...
    Public Function CargarTodos() As Boolean
        Try
            m_listDIST_GuiasRemision = New List(Of EDIST_GuiasTodas)()
    ...
    Public Function Cargar(ByVal x_guiar_codigo As String) As Boolean
        Try
            m_edist_guiasremision = New EDIST_GuiasTodas()
