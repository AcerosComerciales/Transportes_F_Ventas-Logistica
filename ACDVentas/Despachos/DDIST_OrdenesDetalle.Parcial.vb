...
#Region " Procedimientos Almacenados "
	...
	Public Function DIST_ORDETSU_UnReg(ByVal x_dist_ordenesdetalle As EDIST_OrdenesDetalle, ByVal x_usuario As String) As Integer
		...
		End Try
    End Function
    Public Function DIST_ORDETSU_UnReg(ByVal x_dist_ordenesdetalle As EDIST_OrdenesDetalle, ByVal x_usuario As String,
                                       ByVal x_cant As Decimal, ByVal x_almacen As Boolean) As Integer
        Try
            DAEnterprise.AsignarProcedure(getUpdate(x_dist_ordenesdetalle, x_usuario, x_cant, x_almacen), CommandType.Text)
            Return DAEnterprise.ExecuteNonQuery()
        Catch ex As Exception
            Throw ex
        End Try
	...
	#region "Procedimientos Adicionales "
		...
		Private Function getUpdate(ByVal x_dist_ordenesdetalle As EDIST_OrdenesDetalle, ByVal x_usuario As String) As String
			...
			End Try
    End Function
    Private Function getUpdate(ByVal x_dist_ordenesdetalle As EDIST_OrdenesDetalle, ByVal x_usuario As String,
        ...
        Try
            ...
            sql = " UPDATE Logistica.DIST_OrdenesDetalle" & vbNewLine
            sql &= " SET ORDET_CantidadEntregada = " & IIf(IsNothing(x_dist_ordenesdetalle.ORDET_CantidadEntregada), "Null", "'" & x_dist_ordenesdetalle.ORDET_CantidadEntregada & "'") & vbNewLine
            sql &= " , ORDET_UsrMod= " & IIf(IsNothing(x_dist_ordenesdetalle.ORDET_UsrMod), "Null", "'" & x_dist_ordenesdetalle.ORDET_UsrMod & "'") & vbNewLine
            sql &= " , ORDET_FecMod= " & IIf(IsNothing(x_dist_ordenesdetalle.ORDET_FecMod), "Null", "'" & Convert.ToDateTime(x_dist_ordenesdetalle.ORDET_FecMod).ToString("yyyy-MM-dd hh:mm:ss") & "'") & vbNewLine
            sql &= " , ORDET_Motivo = " & IIf(IsNothing(x_dist_ordenesdetalle.ORDET_Motivo), "Null", "'" & x_dist_ordenesdetalle.ORDET_Motivo & "'") & vbNewLine
            sql &= " WHERE "
