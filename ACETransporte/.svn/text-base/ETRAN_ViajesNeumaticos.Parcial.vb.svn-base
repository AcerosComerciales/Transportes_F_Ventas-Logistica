...
#Region " Campos "
	...
	Private m_neumf_id As Long
	Private m_viaje_id As Long
	Private m_zonas_codigo As String
	Private m_sucur_id As Short
	Private m_neuma_id As Long
	Private m_neumf_km As Double
	Private m_neumf_usrcrea As String
	Private m_neumf_feccrea As Date
	Private m_neumf_usrmod As String
	Private m_neumf_fecmod As Date
...
#Region" Constructores "
	...
	Public Sub New()
		...
		Try
			Dim _obj As Object = ACETransporte.My.Resources.xmlTRAN_ViajesNeumaticos
...
#Region" Propiedades "
	...
	Public Property NEUMF_Id() As Long
		Get
			return m_neumf_id
		End Get
		Set(ByVal value As Long)
			If Not IsNothing(m_neumf_id) Then
				If Not m_neumf_id.Equals(value) Then
					m_neumf_id = value
					OnNEUMF_IdChanged(m_neumf_id, EventArgs.Empty)
				End If
			Else
				m_neumf_id = value
				OnNEUMF_IdChanged(m_neumf_id, EventArgs.Empty)
	...
	Public Property NEUMA_Id() As Long
		...
		End Set
	End Property
	Public Property NEUMF_Km() As Double
		Get
			return m_neumf_km
		End Get
		Set(ByVal value As Double)
			If Not IsNothing(m_neumf_km) Then
				If Not m_neumf_km.Equals(value) Then
					m_neumf_km = value
					OnNEUMF_KmChanged(m_neumf_km, EventArgs.Empty)
				End If
			Else
				m_neumf_km = value
				OnNEUMF_KmChanged(m_neumf_km, EventArgs.Empty)
		...
		End Set
	End Property
	Public Property NEUMF_UsrCrea() As String
		Get
			return m_neumf_usrcrea
		End Get
		Set(ByVal value As String)
			m_neumf_usrcrea = value
		End Set
	End Property
	Public Property NEUMF_FecCrea() As Date
		Get
			return m_neumf_feccrea
		End Get
		Set(ByVal value As Date)
			m_neumf_feccrea = value
		End Set
	End Property
	Public Property NEUMF_UsrMod() As String
		Get
			return m_neumf_usrmod
		End Get
		Set(ByVal value As String)
			m_neumf_usrmod = value
		End Set
	End Property
	Public Property NEUMF_FecMod() As Date
		Get
			return m_neumf_fecmod
		End Get
		Set(ByVal value As Date)
			m_neumf_fecmod = value
		End Set
	End Property
...
#Region " Eventos "
	...
	Public Event NEUMF_IdChanged As EventHandler
	...
	Public Event NEUMF_KmChanged As EventHandler
	Public Sub OnNEUMF_IdChanged(ByVal sender As object, ByVal e As EventArgs)
		ActualizarInstancia()
		RaiseEvent NEUMF_IdChanged(sender, e)
	End Sub
	...
	End Sub
	Public Sub OnNEUMF_KmChanged(ByVal sender As object, ByVal e As EventArgs)
		ActualizarInstancia()
		RaiseEvent NEUMF_KmChanged(sender, e)
	End Sub
