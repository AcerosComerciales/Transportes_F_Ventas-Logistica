...
#Region " Campos "
	...
	Private m_dcdet_incgv As Boolean
...
#Region" Constructores "
	...
	Public Sub New()
		...
		Try
			Dim _obj As Object = ACETransporte.My.Resources.xmlTRAN_DocumentosDetalle
...
#Region" Propiedades "
		...
		Set(ByVal value As Decimal)
			If Not IsNothing(m_dcdet_precio) Then
				If Not m_dcdet_precio.Equals(value) Then
					...
					OnDCDET_PrecioChanged(m_dcdet_precio, EventArgs.Empty)
				End If
			Else
				m_dcdet_precio = value
				OnDCDET_PrecioChanged(m_dcdet_precio, EventArgs.Empty)
	...
	Public Property DCDET_IncGV() As Boolean
		Get
			return m_dcdet_incgv
		End Get
		Set(ByVal value As Boolean)
			If Not m_dcdet_incgv.Equals(value) Then
				m_dcdet_incgv = value
				OnDCDET_IncGVChanged(m_dcdet_incgv, EventArgs.Empty)
			End If
		End Set
	End Property
		...
		Set(ByVal value As Decimal)
			If Not IsNothing(m_dcdet_descuento) Then
				If Not m_dcdet_descuento.Equals(value) Then
					...
					OnDCDET_DescuentoChanged(m_dcdet_descuento, EventArgs.Empty)
				End If
			Else
				m_dcdet_descuento = value
				OnDCDET_DescuentoChanged(m_dcdet_descuento, EventArgs.Empty)
...
#Region " Eventos "
	...
	Public Event DCDET_IncGVChanged As EventHandler
	...
	Public Sub OnDCDET_IncGVChanged(ByVal sender As object, ByVal e As EventArgs)
		ActualizarInstancia()
		RaiseEvent DCDET_IncGVChanged(sender, e)
	End Sub
