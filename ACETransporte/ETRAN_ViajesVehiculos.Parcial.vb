...
Partial Public Class ETRAN_ViajesVehiculos

#Region " Campos "
	
	Private m_vehic_id As Long
	Private m_viaje_id As Long
	Private m_viave_kmanterior As Decimal
	Private m_viave_kilometraje As Decimal
...
#Region" Constructores "
	...
	Public Sub New()
		...
		Try
			Dim _obj As Object = ACETransporte.My.Resources.xmlTRAN_ViajesVehiculos
...
#Region" Propiedades "
    ...
    Public Property VIAVE_KmAnterior() As Decimal
        Get
            Return m_viave_kmanterior
        End Get
        Set(ByVal value As Decimal)
            If Not IsNothing(m_viave_kmanterior) Then
                If Not m_viave_kmanterior.Equals(value) Then
                    m_viave_kmanterior = value
                    OnVIAVE_KmAnteriorChanged(m_viave_kmanterior, EventArgs.Empty)
                End If
            Else
                m_viave_kmanterior = value
                OnVIAVE_KmAnteriorChanged(m_viave_kmanterior, EventArgs.Empty)
    ...
    Public Property VIAVE_Kilometraje() As Decimal
		Get
			return m_viave_kilometraje
		End Get
		Set(ByVal value As Decimal)
			If Not IsNothing(m_viave_kilometraje) Then
				If Not m_viave_kilometraje.Equals(value) Then
					m_viave_kilometraje = value
					OnVIAVE_KilometrajeChanged(m_viave_kilometraje, EventArgs.Empty)
				End If
			Else
				m_viave_kilometraje = value
				OnVIAVE_KilometrajeChanged(m_viave_kilometraje, EventArgs.Empty)
...
#Region " Eventos "
	...
	Public Event VIAVE_KmAnteriorChanged As EventHandler
	Public Event VIAVE_KilometrajeChanged As EventHandler
	...
	End Sub
	Public Sub OnVIAVE_KmAnteriorChanged(ByVal sender As object, ByVal e As EventArgs)
		ActualizarInstancia()
		RaiseEvent VIAVE_KmAnteriorChanged(sender, e)
	End Sub
	Public Sub OnVIAVE_KilometrajeChanged(ByVal sender As object, ByVal e As EventArgs)
		ActualizarInstancia()
		RaiseEvent VIAVE_KilometrajeChanged(sender, e)
	End Sub
