...
#Region " Campos "
    ...
    Private m_guiar_revisioncontrol as Boolean
    Private m_guiar_revisionuser As String
...
#Region " Propiedades "
    ...
    Public Property GUIAR_RevisadoControl() As Boolean
        Get
            Return m_guiar_revisioncontrol
        End Get
        Set(ByVal value As Boolean)
            If Not IsNothing(m_guiar_revisioncontrol) Then
                If Not m_guiar_revisioncontrol.Equals(value) Then
                    m_guiar_revisioncontrol = value
                    OnGUIAR_RevisadoControlChanged(m_guiar_revisioncontrol, EventArgs.Empty)
                End If
            Else
                m_guiar_revisioncontrol = value
                OnGUIAR_RevisadoControlChanged(m_guiar_revisioncontrol, EventArgs.Empty)
    ...
    Public Property GUIAR_RevisadoUsr() As String
        Get
            Return m_guiar_revisionuser
        End Get
        Set(ByVal value As String)
            If Not IsNothing(m_guiar_revisionuser) Then
                If Not m_guiar_revisionuser.Equals(value) Then
                    m_guiar_revisionuser = value
                    OnGUIAR_RevisadoUsrChanged(m_guiar_revisionuser, EventArgs.Empty)
                End If
            Else
                m_guiar_revisionuser = value
                OnGUIAR_RevisadoUsrChanged(m_guiar_revisionuser, EventArgs.Empty)
...
#Region " Eventos "
    ...
    Public Event GUIAR_RevisadoControlChanged As EventHandler
    Public Event GUIAR_RevisadoUsrChanged as EventHandler
    ...
    End Sub
     Public Sub OnGUIAR_RevisadoControlChanged(ByVal sender As Object, ByVal e As EventArgs)
        ActualizarInstancia()
        RaiseEvent GUIAR_RevisadoControlChanged(sender, e)
    End Sub
    
      Public Sub OnGUIAR_RevisadoUsrChanged(ByVal sender As Object, ByVal e As EventArgs)
        ActualizarInstancia()
        RaiseEvent GUIAR_RevisadoUsrChanged(sender, e)
    End Sub
