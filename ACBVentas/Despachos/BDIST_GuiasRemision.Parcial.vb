...
#Region " Metodos "
    ...
    Public Function GetTitulo(ByRef x_titulo As String ,ByVal x_lote As String) As String
		Try
			x_titulo = d_dist_guiasremision.getTitulo(x_lote)
			Return x_titulo
		Catch ex As Exception
			Throw ex
		End Try
    ...
    Public Function GetReferencia(ByRef x_titulo As String ,ByVal x_lote As String) As String
		Try
			x_titulo = d_dist_guiasremision.getReference(x_lote)
			Return x_titulo
		Catch ex As Exception
			Throw ex
		End Try
