...
Public Class BABAS_OrdenesProduccionDetalle
...
Partial Public Class BABAS_OrdenesProduccionDetalle

#Region " Variables "
	
	Private m_edist_ordenesdetalle As EABAS_OrdenesProduccionDetalle
	...
	Private d_dist_ordenesdetalle As DABAS_OrdenesProduccionDetalle 
...
#Region " Constructores "
	...
	Public Sub New()
		d_dist_ordenesdetalle = New DABAS_OrdenesProduccionDetalle()
	End Sub
...
#Region " Propiedades "
	...
	Public Property DIST_OrdenesDetalle() As EABAS_OrdenesProduccionDetalle 
		Get
			return m_edist_ordenesdetalle
		End Get
		Set(ByVal value As EABAS_OrdenesProduccionDetalle)
...
#Region " Metodos "
	...
	Public Function CargarTodos() As Boolean
		Try
			m_listDIST_OrdenesDetalle = new List(Of EABAS_OrdenesProduccionDetalle)()
	...
	Public Function CargarTodos(ByVal x_orden_codigo As String) As Boolean
		Try
			m_edist_ordenesdetalle = New EABAS_OrdenesProduccionDetalle()
