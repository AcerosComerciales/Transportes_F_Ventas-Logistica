...
#Region " Metodos "
    ...
    Public Function EliminarTodo(ByVal x_where As Hashtable) As Boolean
		Try
			m_listDIST_Ordenes = new List(Of EDIST_Ordenes)()
			return d_dist_ordenes.DIST_ORDENSD_UnReg_Todo(x_where) > 0
		Catch ex As Exception
			Throw ex
		End Try
	End Function
    ...
    Public Function getSerie(ByVal x_campo As String, ByVal x_where As Hashtable) As String
		Try
			Return d_dist_ordenes.getSerie(x_campo, x_where) 
		Catch ex As Exception
			Throw ex
		End Try
	End Function
    ...
    Public Function getImpresion( ByVal x_where As Hashtable) As Boolean
		Try
			Return d_dist_ordenes.getImpresion( x_where) 
		Catch ex As Exception
			Throw ex
		End Try
	End Function
