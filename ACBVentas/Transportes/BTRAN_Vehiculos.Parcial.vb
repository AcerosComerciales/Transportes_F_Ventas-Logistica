...
#Region " Propiedades "
	...
	Public Property TRAN_Vehiculos() As ETRAN_Vehiculos 
		Get
			return m_etran_vehiculos
		End Get
		Set(ByVal value As ETRAN_Vehiculos)
			m_etran_vehiculos = value
		End Set
	End Property
...
#Region " Metodos "
	...
	Public Function Cargar(ByVal x_vehic_id As Long) As Boolean
		Try
			...
			Return d_tran_vehiculos.TRAN_VEHICSS_UnReg(m_etran_vehiculos, x_vehic_id)
		Catch ex As Exception
			Throw ex
		End Try
	End Function
	...
	Public Function Cargar(ByVal x_where As Hashtable) As Boolean
		Try
			m_etran_vehiculos = New ETRAN_Vehiculos()
			Return d_tran_vehiculos.TRAN_VEHICSS_UnReg(m_etran_vehiculos, x_where)
		Catch ex As Exception
			Throw ex
		End Try
	End Function
	...
	Public Function Cargar(ByVal x_join As List(Of ACFramework.ACJoin), ByVal x_where As Hashtable) As Boolean
		Try
			m_etran_vehiculos = New ETRAN_Vehiculos()
			Return d_tran_vehiculos.TRAN_VEHICSS_UnReg(m_etran_vehiculos, x_join, x_where)
		Catch ex As Exception
			Throw ex
		End Try
	End Function
	...
	Public Function Guardar(ByVal x_usuario As String) As Boolean
		Try
			...
			ElseIf m_etran_vehiculos.Eliminado Then
				d_tran_vehiculos.TRAN_VEHICSD_UnReg(TRAN_Vehiculos)
			End If
			Return True
		Catch ex As Exception
			Throw ex
	...
	Public Function Guardar(ByVal x_where As Hashtable, ByVal x_usuario As String) As Boolean
		Try
			If m_etran_vehiculos.Nuevo Then
				d_tran_vehiculos.TRAN_VEHICSI_UnReg(m_etran_vehiculos, x_usuario)
			ElseIf m_etran_vehiculos.Modificado Then
				d_tran_vehiculos.TRAN_VEHICSU_UnReg(m_etran_vehiculos, x_where, x_usuario)
			ElseIf m_etran_vehiculos.Eliminado Then
	...
	Public Function Guardar(ByVal x_where As Hashtable, ByVal x_usuario As String, ByVal x_excluir() As String, ByVal x_setfecha() As String) As Boolean
		Try
			If m_etran_vehiculos.Nuevo Then
				d_tran_vehiculos.TRAN_VEHICSI_UnReg(m_etran_vehiculos, x_usuario, x_excluir, x_setfecha)
			ElseIf m_etran_vehiculos.Modificado Then
				d_tran_vehiculos.TRAN_VEHICSU_UnReg(m_etran_vehiculos, x_where, x_usuario, x_excluir, x_setfecha)
			ElseIf m_etran_vehiculos.Eliminado Then
				d_tran_vehiculos.TRAN_VEHICSD_UnReg(TRAN_Vehiculos)
			End If
			Return True
	...
	Public Function Guardar(ByVal x_where As Hashtable, ByVal x_usuario As String, ByVal x_excluir() As String, ByVal x_setfecha() As String, ByVal x_setcampos() As String) As Boolean
		Try
			If m_etran_vehiculos.Nuevo Then
				d_tran_vehiculos.TRAN_VEHICSI_UnReg(m_etran_vehiculos, x_usuario, x_excluir, x_setfecha)
			ElseIf m_etran_vehiculos.Modificado Then
				d_tran_vehiculos.TRAN_VEHICSU_UnReg(m_etran_vehiculos, x_where, x_usuario, x_excluir, x_setfecha, x_setcampos)
			ElseIf m_etran_vehiculos.Eliminado Then
				d_tran_vehiculos.TRAN_VEHICSD_UnReg(TRAN_Vehiculos)
			End If
			Return True
	...
	Public Function Guardar(ByVal x_usuario As String, ByVal x_setfecha() As String) As Boolean
		Try
			If m_etran_vehiculos.Nuevo Then
				d_tran_vehiculos.TRAN_VEHICSI_UnReg(m_etran_vehiculos, x_usuario, x_setfecha)
			ElseIf m_etran_vehiculos.Modificado Then
				d_tran_vehiculos.TRAN_VEHICSU_UnReg(m_etran_vehiculos, x_usuario, x_setfecha)
			ElseIf m_etran_vehiculos.Eliminado Then
				d_tran_vehiculos.TRAN_VEHICSD_UnReg(TRAN_Vehiculos)
			End If
			Return True
