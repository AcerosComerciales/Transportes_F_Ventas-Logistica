...
#Region " Procedimientos Almacenados "
	...
	Public Function TRAN_VEHICSS_Todos(ByRef listETRAN_Vehiculos As List(Of ETRAN_Vehiculos)) As Boolean
		Try
		...
		End Try
	End Function
	Public Function TRAN_VEHICSS_Todos(ByRef listETRAN_Vehiculos As List(Of ETRAN_Vehiculos), ByVal x_where As Hashtable) As Boolean
		Try
		...
		End Try
	End Function
	Public Function TRAN_VEHICSS_Todos(ByRef listETRAN_Vehiculos As List(Of ETRAN_Vehiculos), ByVal x_join As List(Of ACJoin), ByVal x_where As Hashtable) As Boolean
		Try
		...
		End Try
	End Function
	Public Function TRAN_VEHICSS_Todos(ByRef listETRAN_Vehiculos As List(Of ETRAN_Vehiculos), ByVal x_join As List(Of ACJoin), ByVal x_where As Hashtable, ByVal x_distinct As Boolean) As Boolean
		Try
	...
	Public Function TRAN_VEHICSS_Todos(ByRef m_datos As DataSet, ByVal x_join As List(Of ACJoin), ByVal x_where As Hashtable) As Boolean
		...
		End Try
	End Function
	Public Function TRAN_VEHICSS_UnReg(ByRef x_tran_vehiculos As ETRAN_Vehiculos, ByVal x_vehic_id As Long) As Boolean
		Try
			DAEnterprise.AsignarProcedure(getSelectBy(x_vehic_id), CommandType.Text)
			Using reader As DbDataReader = DAEnterprise.ExecuteDataReader()
				If reader.HasRows Then
					reader.Read()
					ACEsquemas.ACCargarEsquema(reader, x_tran_vehiculos)
					x_tran_vehiculos.Instanciar(ACEInstancia.Consulta)
					return True
				Else
					Return False
				End If
		...
		End Try
	End Function
	Public Function TRAN_VEHICSS_UnReg(ByRef x_tran_vehiculos As ETRAN_Vehiculos, ByVal x_where As Hashtable) As Boolean
		Try
			DAEnterprise.AsignarProcedure(getSelectAll(x_where), CommandType.Text)
			Using reader As DbDataReader = DAEnterprise.ExecuteDataReader()
				If reader.HasRows Then
		...
		End Try
	End Function
	Public Function TRAN_VEHICSS_UnReg(ByRef x_tran_vehiculos As ETRAN_Vehiculos, ByVal x_join As List(Of ACJoin), ByVal x_where As Hashtable) As Boolean
		Try
			DAEnterprise.AsignarProcedure(getSelectAll(x_join, x_where), CommandType.Text)
			Using reader As DbDataReader = DAEnterprise.ExecuteDataReader()
				If reader.HasRows Then
