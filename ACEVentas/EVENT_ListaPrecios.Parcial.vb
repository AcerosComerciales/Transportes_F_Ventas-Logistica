...
#Region " Campos "
	...
	Private m_lprec_usrcrea As String
	Private m_lprec_feccrea As Date
	Private m_lprec_usrmod As String
	Private m_lprec_fecmod As Date
...
#Region" Constructores "
	...
	Public Sub New()
		...
		Try
			Dim _obj As Object = ACEVentas.My.Resources.xmlVENT_ListaPrecios
...
#Region" Propiedades "
	...
	Public Property LPREC_Codigo() As String
		...
		End Get
		Set(ByVal value As String)
			If Not IsNothing(m_lprec_codigo) Then
				If Not m_lprec_codigo.Equals(value) Then
					m_lprec_codigo = value
					OnLPREC_CodigoChanged(m_lprec_codigo, EventArgs.Empty)
				End If
			Else
				m_lprec_codigo = value
				OnLPREC_CodigoChanged(m_lprec_codigo, EventArgs.Empty)
	...
	Public Property LPREC_Descripcion() As String
		...
		End Set
	End Property
	Public Property LPREC_UsrCrea() As String
		Get
			return m_lprec_usrcrea
		End Get
		Set(ByVal value As String)
			m_lprec_usrcrea = value
		End Set
	End Property
	Public Property LPREC_FecCrea() As Date
		Get
			return m_lprec_feccrea
		End Get
		Set(ByVal value As Date)
			m_lprec_feccrea = value
		End Set
	End Property
	Public Property LPREC_UsrMod() As String
		Get
			return m_lprec_usrmod
		End Get
		Set(ByVal value As String)
			m_lprec_usrmod = value
		End Set
	End Property
	Public Property LPREC_FecMod() As Date
		Get
			return m_lprec_fecmod
		End Get
		Set(ByVal value As Date)
			m_lprec_fecmod = value
		End Set
	End Property
...
#Region " Eventos "
	...
	Public Event LPREC_CodigoChanged As EventHandler
	...
	End Sub
	Public Sub OnLPREC_CodigoChanged(ByVal sender As object, ByVal e As EventArgs)
		ActualizarInstancia()
		RaiseEvent LPREC_CodigoChanged(sender, e)
	End Sub
