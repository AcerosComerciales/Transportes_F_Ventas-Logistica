...
#Region" Constructores "
	...
	Public Sub New()
		...
		Try
			Dim _obj As Object = ACEVentas.My.Resources.xmlDIST_GuiasRemisionDetalle
...
#Region" Propiedades "
    ...
    Public Property GUIRD_PesoUnitario() As Double
        Get
        ...
        End Set
    End Property
    Public Property GUIRD_Lote() As Integer
        Get
            Return m_lote
        End Get
        Set(ByVal value As Integer)
            If Not IsNothing(m_lote) Then
                If Not m_lote.Equals(value) Then
                    m_lote = value
                    OnGUIRD_LoteChanged(m_lote, EventArgs.Empty)
                End If
            Else
                m_lote = value
                OnGUIRD_LoteChanged(m_lote, EventArgs.Empty)
        ...
        End Set
    End Property
        Public Property GUIRD_LoteGeneral() As Integer
        Get
        ...
        Set(ByVal value As Integer)
            If Not IsNothing(m_loteGeneral) Then
                If Not m_loteGeneral.Equals(value) Then
                    m_loteGeneral = value
                    OnGUIRD_LoteGeneralChanged(m_loteGeneral, EventArgs.Empty)
                End If
            Else
                m_loteGeneral = value
                OnGUIRD_LoteGeneralChanged(m_loteGeneral, EventArgs.Empty)
    ...
    Public Property GUIRD_Cantidad() As Double
        Get
...
#Region " Eventos "
    ...
    Public Event GUIRD_LoteChanged As EventHandler
    Public Event GUIRD_LoteGeneralChanged as EventHandler
	...
	End Sub
      Public Sub OnGUIRD_LoteChanged(ByVal sender As object, ByVal e As EventArgs)
		ActualizarInstancia()
		RaiseEvent GUIRD_LoteChanged(sender, e)
	End Sub
    Public Sub OnGUIRD_LoteGeneralChanged(ByVal sender As object, ByVal e As EventArgs)
		ActualizarInstancia()
		RaiseEvent GUIRD_LoteGeneralChanged(sender, e)
	End Sub
