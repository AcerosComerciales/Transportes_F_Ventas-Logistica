...
#Region " Metodos "
   ...
   End Function
            ...
            If (d_tran_vehiculos.TRAN_VEHICSS_UnReg(m_tran_vehiculos, x_vehic_id)) Then
                Select Case x_opcion
                    Case ETRAN_Vehiculos.Inicializacion.Ranflas
                        ...
                        'ESTO LO QUE HACE ES ASIGNAR LAS MISMAS LISTAS DE ListTRAN_VehiculosRanflas a  ListTRAN_HRanflas 
    ...
    Public function CargarConductorXNombre(bYVAL Nombre As String  ) As Boolean 
        Try
            ...
            x_vehic_id = m_tran_vehiculos.VEHIC_Id
                 Dim x_tran_vehiculosconductores As New BTRAN_VehiculosConductores()
                    x_tran_vehiculosconductores.CargarConductoresXNombre(x_vehic_id, True, True, EEntidades.TipoEntidad.Conductores,Nombre)
    ...
    Public Function Cargar(ByVal x_opcion As ETRAN_Vehiculos.Inicializacion) As Boolean
        ...
        Try
            ...
            Select Case x_opcion
               ...
               ''***************************************************************************************************
                Case ETRAN_Vehiculos.Inicializacion.MantenimientoPreventivo
                    ''***************************************************************************************************
                    ...
                    _where.Add("VMAN_Viaje", New ACFramework.ACWhere(True, ACFramework.ACWhere.TipoWhere.Igual))
                    ...
                    '==============================================================================================================================================================
                    'Dim x_tran_vehiculosmantenimiento As New BTRAN_VehiculosViajesMantenimiento()
                    '' Crear Inner Join Con otras Tablas
                    'Dim _join As New List(Of ACJoin)
                    '_join.Add(New ACJoin("dbo", "Tipos", ACFramework.ACJoin.TipoJoin.Inner _
                    '              , New ACCampos() {New ACCampos("TIPOS_Codigo", "TIPOS_CodTipoMantenimiento")} _
                    ...
                    'm_tran_vehiculos.ListVViajesMantenimiento = New List(Of ETRAN_VehiculosViajesMantenimiento)(x_tran_vehiculosmantenimiento.ListTRAN_VehiculosMantenimiento)
                    ''***************************************************************************************************
               ...
               ''***************************************************************************************************
                Case ETRAN_Vehiculos.Inicializacion.Seguros
                    ...
                    Dim _where As New Hashtable()
                    _where.Add("VEHIC_Id", New ACFramework.ACWhere(x_vehic_id, ACFramework.ACWhere.TipoWhere.Igual))
                    _where.Add("SEGVH_Estado", New ACWhere("I", ACWhere.TipoWhere.Igual))
