...
Public Class CRCuentasCorrientes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRCuentasCorrientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPTransportes.CRCuentasCorrientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCuentasCorrientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCuentasCorrientes = New CRCuentasCorrientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
