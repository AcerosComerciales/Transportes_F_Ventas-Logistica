...
Public Class CRFacturasElec
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPTransportes.CRFacturasElec.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRFacturasElec
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRFacturasElec = New CRFacturasElec()
        rpt.Site = Me.Site
        Return rpt
    End Function
