...
Public Class CRCotizacionAC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPTransportes.CRCotizacionAC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCotizacionAC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCotizacionAC = New CRCotizacionAC()
        rpt.Site = Me.Site
        Return rpt
    End Function
