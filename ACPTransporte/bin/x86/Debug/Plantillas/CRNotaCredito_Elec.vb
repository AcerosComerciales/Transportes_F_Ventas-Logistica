...
Public Class CRNotaCredito_Elec
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPTransportes.CRNotaCredito_Elec.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRNotaCredito_Elec
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRNotaCredito_Elec = New CRNotaCredito_Elec()
        rpt.Site = Me.Site
        Return rpt
    End Function
