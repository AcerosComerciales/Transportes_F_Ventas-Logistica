...
Public Class CRGuiaRemisionTransportista
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRGuiaRemisionTransportista.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPTransportes.CRGuiaRemisionTransportista.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_destino_copia_() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRGuiaRemisionTransportista
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRGuiaRemisionTransportista = New CRGuiaRemisionTransportista()
        rpt.Site = Me.Site
        Return rpt
    End Function
