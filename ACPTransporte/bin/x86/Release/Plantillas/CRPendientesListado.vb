...
Public Class CRPendientesListado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRPendientesListado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPTransportes.CRPendientesListado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPendientesListado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPendientesListado = New CRPendientesListado()
        rpt.Site = Me.Site
        Return rpt
    End Function
