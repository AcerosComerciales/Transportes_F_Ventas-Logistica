...
Public Class Constantes
   ...
   Public Enum CadCtrlGeneraVale
      NoGenera
      GeneraSalida
      GeneraDevolucion
   End Enum

   Public Enum TipoDocCompra
      Orden_Compra = 0
      Compra = 1
   End Enum

   Public Enum EstadoDocCompra
      Ingresado = 0
      Aprobado = 1
      Cerrado = 2
   End Enum
...
#Region "Tipos de Entidad"
   ...
   Public Shared ReadOnly Property Clientes() As Integer
      Get
         Return 2
      End Get
   End Property

   Public Shared ReadOnly Property Proveedores() As Integer
      Get
         Return 3
      End Get
   End Property

   Public Shared ReadOnly Property Trabajadores() As Integer
      Get
         Return 4
      End Get
   End Property
