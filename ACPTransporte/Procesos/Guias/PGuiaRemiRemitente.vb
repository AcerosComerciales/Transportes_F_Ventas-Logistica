...
Public Class FGuiaRemiRemitente
...
#Region " Variables "
   ...
   Private m_eliminargr As Boolean
...
#Region " Constructores "
   ...
   Public Sub New(ByVal x_gtran_codigo As String)
      ' This call is required by the Windows Form Designer.
      InitializeComponent()
      ...
      Try
         Inicializacion()
         'acpnlTitulo.ACCaption = String.Format(acpnlTitulo.ACCaption, "Guia de Traslado Interno - Salida por Transferencia")
         Previsualizar(x_gtran_codigo)
         actool.ACBtnImprimir.Visible = False
   ...
   Private Sub Inicializacion()
      Try
         ...
         GApp.DataUsuario.PROC_Codigo = Procesos.getProceso(Procesos.TipoProcesos.EliminarGuiaRemision)
         Dim _validate As New ACSeguridad.ACValidarUsuario(GApp.DataConexion, GApp.DataUsuario, ACSeguridad.ACValidarUsuario.Operacion.ValidarProceso)
         m_eliminargr = _validate.ACProceso
...
#Region " Metodos "
            ...
            Select Case x_tipoentidad
               Case EEntidades.TipoEntidad.Proveedores
                  If managerEntidades.Cargar(frmEntidad.EEntidad.ENTID_Codigo, EEntidades.TipoInicializacion.Direcciones) Then
                     ...
                     m_etran_guiastransportista.ENTID_Codigo = managerEntidades.Entidades.ENTID_Codigo
                     ...
                     If managerEntidades.Entidades.ListDirecciones.Count > 0 Then
                        ...
                        End If
                     End If
                     setRolCliente(ACETransporte.Constantes.Seteo.Desactivar)
   ...
   Private Sub setRolCliente(ByVal x_opcion As ACETransporte.Constantes.Seteo)
      Try
         actxaDescProveedor.ReadOnly = IIf(x_opcion = ACETransporte.Constantes.Seteo.Activar, False, True)
         actxaDescProveedor.ACActivarAyuda = IIf(x_opcion = ACETransporte.Constantes.Seteo.Activar, True, False)
         actxaDescProveedor.ACAyuda.Enabled = IIf(x_opcion = ACETransporte.Constantes.Seteo.Activar, True, False)
         actxaNroDocProveedor.ReadOnly = IIf(x_opcion = ACETransporte.Constantes.Seteo.Activar, False, True)
         actxaNroDocProveedor.ACAyuda.Enabled = IIf(x_opcion = ACETransporte.Constantes.Seteo.Activar, True, False)
         actxaNroDocProveedor.ACActivarAyuda = IIf(x_opcion = ACETransporte.Constantes.Seteo.Activar, True, False)
      Catch ex As Exception
         Throw ex
      End Try
   End Sub

   Private Sub actxaCodProveedor_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles actxaNroDocProveedor.KeyDown
      Try
   ...
   Private Sub Previsualizar(ByVal x_gtran_codigo As String)
      Try
         ...
         If m_bGenerarGuias.GuiaTransportista(x_gtran_codigo, ETRAN_GuiasTransportista.getEstado(ETRAN_GuiasTransportista.Estado.Anulado)) Then
            ...
            If m_bdetaguia.CargarTodos(_detwhere) Then
               ...
               'actxaRucDestinatario.Text = m_etran_guiastransportista.GTRAN_RUCRemitente
               actxaRazSocDestinatario.Text = Parametros.GetParametro(EParametros.TipoParametros.EmpresaRS)
               'actxaRazSocDestinatario.Text = m_etran_guiastransportista.GTRAN_RUCLl

               actxaNroDocTransportista.Text = m_etran_guiastransportista.ENTID_TranRUC
               actxaNroDocConductor.Text = m_etran_guiastransportista.ENTID_CondRUC
...
#Region " Utilitarios "
   ...
   Private Function busqueda(ByVal x_cadena As String, Optional ByVal x_documento As Boolean = False) As Boolean
      Try
         ...
         Else
            ...
            If managerGenerarGuias.Busqueda(x_cadena, getCampo(), GApp.Sucursal, chkTodos.Checked, ETipos.getTipoDocTraslado(ETipos.TipoDocsTraslado.GuiaRemisionRemitente), acFecha.ACDtpFecha_De.Value.Date, acFecha.ACDtpFecha_A.Value.Date.AddDays(1)) Then
               actool.ACBtnEliminarEnabled = True
               actool.ACBtnModificarEnabled = True
            Else
               actool.ACBtnEliminarEnabled = False
   ...
   Private Function getCampo() As String
      Try
         If (rbtnProveedor.Checked) Then
            Return "GTRAN_DescEntidadProveedor"
   ...
   Private Sub cargarCombos()
      Try
         ...
         For Each Item As ETipos In Colecciones.TiposGuiaRemisionRemitente
      ...
      Try
         ...
         Select Case _opcion
            ...
            Case ACUtilitarios.ACSetInstancia.Previsualizar
               ...
               actool.ACBtnImprimirEnabled = True
               actool.ACBtnEliminarVisible = m_eliminargr
               SetControles(False)
         End Select
      Catch ex As Exception
         Throw ex
   ...
   Private Sub SetControles(ByVal x_opcion As Boolean)
      ...
      actxaDescProveedor.ACActivarAyuda = x_opcion : actxaDescProveedor.ACAyuda.Enabled = x_opcion
      actxaNroDocProveedor.ACActivarAyuda = x_opcion : actxaNroDocProveedor.ACAyuda.Enabled = x_opcion
      ...
      btnNueProveedor.Enabled = x_opcion : btnClean.Enabled = x_opcion
   ...
   Private Sub subirItem()
      Try
         'If IsNothing(CType(bs_doctrasaladodetalle.Current, ETRAN_GuiasTransportistaDetalles).GTRAN_Id) Then
         '   '' Cargar Producto
         '   actxaProdCodigo.Text = CType(bs_doctrasaladodetalle.Current, ETRAN_GuiasTransportistaDetalles).GTRAN_Id
         '   txtProdDescripcion.Text = CType(bs_doctrasaladodetalle.Current, ETRAN_GuiasTransportistaDetalles).GTDET_Descripcion
         '   actxnProdCantidad.Text = CType(bs_doctrasaladodetalle.Current, ETRAN_GuiasTransportistaDetalles).GTDET_Cantidad
         'Else
         '   'm_earticulos = CType(bs_doctrasaladodetalle.Current, ETRAN_GuiasTransportistaDetalles).ARTIC_Codigo
         '   setProducto(True)
         '   actxnProdCantidad.Text = CType(bs_doctrasaladodetalle.Current, ETRAN_GuiasTransportistaDetalles).GTDET_Cantidad
         'End If
      Catch ex As Exception
   ...
   Private Sub formatearGrilla()
      ...
      Try
         ACFrameworkC1.ACUtilitarios.ACFormatearGrilla(c1grdBusqueda, 1, 1, 18, 1, 1)
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Doc. Proveedor", "GTRAN_RucProveedor", "GTRAN_RucProveedor", 150, True, False, "System.String") : index += 1
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Proveedor", "GTRAN_DescEntidadProveedor", "GTRAN_DescEntidadProveedor", 150, True, False, "System.String") : index += 1
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Nro.Pedido", "GTRAN_NroPedido", "GTRAN_NroPedido", 150, True, False, "System.String") : index += 1
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdDetalle, index, "Peso", "GTDET_Peso", "GTDET_Peso", 80, True, False, "System.Decimal", Parametros.GetParametro(Parametros.TipoParametros.pg_FMondo4d)) : index += 1
   ...
   Private Function addDetallePedido() As Boolean
      Try
         ...
         If IsNothing(m_earticulos) Then
            _detGuiaRemision.ARTIC_Codigo = actxaProdCodigo.Text
         ...
         Else
            ...
            _detGuiaRemision.GTDET_Descripcion = m_earticulos.ARTIC_Descripcion
         End If
...
#End Region
            ...
            Case EEntidades.TipoEntidad.Proveedores
               ...
               If managerEntidades.Ayuda(_where, x_opcion) Then
                  ...
                  If Ayuda.ShowDialog() = Windows.Forms.DialogResult.OK Then
                     ...
                     m_etran_guiastransportista.ENTID_Codigo = Ayuda.Respuesta.Rows(0)("Codigo")
   ...
   Private Sub AsignarBinding()
      Try
         ...
         m_listBindHelper.Add(ACBindHelper.ACBind(actxaNroDocProveedor, "Text", m_etran_guiastransportista, "GTRAN_RucProveedor"))
         m_listBindHelper.Add(ACBindHelper.ACBind(actxaDescProveedor, "Text", m_etran_guiastransportista, "GTRAN_DescEntidadProveedor"))
...
#Region "Ayudas"
   ...
   Private Sub actxaNroDocConductor_ACAyudaClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles actxaNroDocConductor.ACAyudaClick
      Try
         AyudaEntidad(actxaDescConductor.Text, "ENTID_NroDocumento", EEntidades.TipoEntidad.Conductores)
      Catch ex As Exception
         ACControles.ACDialogos.ACMostrarMensajeError(String.Format("Error: {0}", Me.Text), "Ocurrio un error en el proceso cargar Conductor", ex)
      End Try
   End Sub
...
#Region " Textos "
   ...
   Private Sub txtNumeroPedido_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtNumeroPedido.KeyDown
...
#End Region
   ...
   Private Sub btnNuevoCliente_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNueProveedor.Click
   ...
   Private Sub btnClean_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClean.Click
      Try
         ...
         actxaDescProveedor.Clear() : actxaNroDocProveedor.Clear()
         ...
         setRolCliente(ACETransporte.Constantes.Seteo.Activar)
...
#End Region
   ...
   Private Sub actool_ACBtnEliminar_Click(sender As Object, e As EventArgs) Handles actool.ACBtnEliminar_Click
      Try
         If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Eliminar Registro: {0}", Me.Text) _
                                     , String.Format("Desea eliminar la Guia de Remisión: {0} ", CType(bs_etran_guiastransportista.Current, ETRAN_GuiasTransportista).Documento) _
                                     , ACControles.ACDialogos.LabelBotom.Si_No) = DialogResult.Yes Then
            If managerGenerarGuias.Eliminar(CType(bs_etran_guiastransportista.Current, ETRAN_GuiasTransportista).GTRAN_Codigo, GApp.Usuario) Then
               ACControles.ACDialogos.ACMostrarMensajeSatisfactorio(String.Format("Información: {0}", Me.Text), "Elimiando satisfactoriamente")
               setInstancia(ACUtilitarios.ACSetInstancia.Deshacer)
               acTool_ACBtnCancelar_Click(Nothing, Nothing)
               btnConsultar_Click(Nothing, Nothing)
            Else
               Throw New Exception("No se completo el proceso de eliminar Guia")
            End If
         End If
      Catch ex As Exception
         ACControles.ACDialogos.ACMostrarMensajeError(String.Format("Error: {0}", Me.Text), String.Format(Colecciones.getError("00101"), "Eliminar Guia de Remisión"), ex)
      End Try
   End Sub
