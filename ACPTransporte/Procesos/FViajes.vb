...
#Region " Variables "
    Private managerTRAN_Viajes As BTRAN_Viajes 'COMPARAR BTRAN_VIAJES -->TRAE DOCUMENTOS 
    Private managerEntidades As BEntidades
    Private managerTRAN_VehiculosConductores As BTRAN_VehiculosConductores
    Private managerTRAN_Vehiculos As BTRAN_Vehiculos 'CON ESTE BTRAN_VEHICULOS -->NO TRAE DOCUMENTOS 
    ...
    Private managerTRAN_ViajesVehiculos As BTRAN_ViajesVehiculos
    ...
    Private bs_tran_consumoadblue As BindingSource
    ...
    Private m_ViajeMantenimientoKM As Decimal = 0
    Private m_reimprimir As Boolean = False

    Private banderaTabControl As Boolean = False
...
#Region " Propiedades "
    'Evento TabControl by Frank 07-11-2025 
    Enum EventoTabControl
        VehiculoRanflaFlete
        ConsumoCombustible
        ConsumoAdblue
        GastosDelViaje
...
#Region " Constructores "
    Public Sub New(ByVal x_opcion As TipoFormulario)
        ...
        Try
            ...
            managerTRAN_ViajesVehiculos = New BTRAN_ViajesVehiculos 'Variabel creado 
            ...
            bnavConsumoAdBlue.Visible = True
    ...
    Private Sub Inicializar()
        ...
        End Try
    End Sub
    Private Function CalcularProximo_MantenimientoKM(ByVal KmInicio As Decimal, ByVal KmTopeMantenimiento As Decimal) As String
        Dim KmProximoMantenimiento As Decimal = 0
        If (KmTopeMantenimiento = 0) Then
            actxnVehKilometrajeMantenimiento_.Text = "SN/Mant."
        Else
            KmProximoMantenimiento = KmInicio - KmTopeMantenimiento
            actxnVehKilometrajeMantenimiento_.Text = KmProximoMantenimiento.ToString("N2")
            ProximoMantenimientoBackColor(KmProximoMantenimiento.ToString("N2"))
            Dim BackcolorProximoMantenimiento As Color = ProximoMantenimientoBackColor(KmProximoMantenimiento)
            Dim ForeColorProximoMantenimiento As Color = ProximoMantenimientoForeColor(KmProximoMantenimiento)

            actxnVehKilometrajeMantenimiento_.BackColor = BackcolorProximoMantenimiento
            actxnVehKilometrajeMantenimiento_.ForeColor = ForeColorProximoMantenimiento
        End If
        Return KmProximoMantenimiento.ToString("N2")
    End Function
    Public Function ProximoMantenimientoBackColor(ByVal km_confirmar As Decimal) As Color
        Select Case km_confirmar
            Case Is < 0
                Return Color.Red
            Case Is < 1000
                Return Color.Red
        ...
        End Select
    End Function
    Public Function ProximoMantenimientoForeColor(ByVal km_confirmar As Decimal) As Color
        Select Case km_confirmar
            Case Is < 0
                Return Color.White
            Case Is < 1000
...
#Region " Utilitarios "
    ...
    Private Sub formatearGrilla()
        ...
        Try
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Ultimo.Mantenimiento.Regis.", "VIAJE_MantenimientoKM", "VIAJE_MantenimientoKM", 100, True, False, "System.String") : index += 1
    ...
    Private Sub cargarCombos()
        Try
            ...
            _lista.Add(New ACLista(String.Empty, "Vuelta"))
...
#Region " Cargar Datos Generales del Viaje "
    ...
    Private Sub AsignarBinding()
        Try
            ...
            '''AddBlue _M 20251003
            m_listBindHelper.Add(ACBindHelper.ACBind(actxnAddBlueRealizado, "Text", managerTRAN_Viajes.TRAN_Viajes, "VIAJE_AddBlueConsumido"))
            m_listBindHelper.Add(ACBindHelper.ACBind(actxnConsAddBlueRealizado, "Text", managerTRAN_Viajes.TRAN_Viajes, "VIAJE_ConsumoAddBlueRealizado"))
    ...
    Private Sub cargar()
        Try
            'Cargar Datos de un Viaje especifijo despuesd de hacer un Doble click a la tabla 
            If bs_tran_viajes.Current IsNot Nothing Then
                Dim x_codigo As Integer = CType(bs_tran_viajes.Current, ETRAN_Viajes).VIAJE_Id
                '     CalcularProximo_MantenimientoKM(managerTRAN_Viajes.TRAN_Viajes.VIAJE_KmTotal, managerTRAN_Viajes.TRAN_Viajes.VIAJE_MantenimientoKM)
                ...
                If managerTRAN_Viajes.CargarXML(x_codigo) Then
                    ...
                    managerTRAN_Viajes.TRAN_Viajes.TRAN_ViajesVehiculos.VIAVE_KmAnterior = managerAdministracionViajes.ObtenerKMAnterior(globales_.v_vehiculo_id)
                    actxnKmAnterior.Text = managerTRAN_Viajes.TRAN_Viajes.TRAN_ViajesVehiculos.VIAVE_KmAnterior
                    'End If
                    ...
                    actxnVehKilometrajeMantenimiento.Text = CType(bs_tran_viajes.Current, ETRAN_Viajes).VIAJE_MantenimientoKM
...
#End Region
    ...
    Private sub SetSubReCargarTab(Byval x_opcion As TipoCarga)  'funcion creado frank 06-11-2025 
        Try
            Select Case x_opcion 
                Case  TipoCarga.Base
                    ...
                    tcnDetalle.SelectedTab = tpgConsCombustible
                    Case TipoCarga.ConsumoAdBlue
                    tcnDetalle.SelectedTab = tpgConsumoAdBlue
        ...
        Try
            Select Case x_opcion
                ...
                Case TipoCarga.ConsumoAdBlue
                    cargarVRC()
                    cargarConsumoAdBlue()
                    If x_cambiarTab Then tcnDetalle.SelectedTab = tpgConsumoAdBlue
        ...
        Try
            ...
            If IsNothing(managerAdministracionViajes.ListTRAN_CombustibleConsumo) Then
                SetCarga(TipoCarga.ConsCombustible)
                          '      RecibeParametrosParaControlarTabConsumoCombustible(TipoCarga.ConsCombustible) 'FUNCION CREADO EL 07-11-2025
            ...
            '' Consumo de AddBlue
            If IsNothing(managerAdministracionViajes.ListTRAN_CombustibleConsumo) Then
                SetCarga(TipoCarga.ConsumoAdBlue,False)
                     'RecibeParametrosParaControlarTabConsumoCombustible(TipoCarga.ConsumoAdBlue) 'FUNCION CREADO EL 07-11-2025
            Else
                managerAdministracionViajes.ListTRAN_CombustibleConsumo = Nothing
               'Dim  band_ as boolean = false 
               ' If globales_.x_BanderGrabarCombustible=True  Then 
               '     band_ = False 
               '     Else 
               '     band_ = True 
               ...
               ' End if 
                ...
                For Each Item As ETRAN_CombustibleConsumo In managerAdministracionViajes.ListTRAN_CombustibleConsumo
                    If Item.COMCO_CCaja Then
                        _consumoaddblue += Item.COMCO_Total
                    End If
                    _addblue += Item.COMCO_GalonesConsumidos
                Next
            ...
            actxnConsAddBlueRealizado.Text = _consumoaddblue : actxnConsAddBlueRealizado.Formatear()
            actxnAddBlueRealizado.Text = _addblue : actxnAddBlueRealizado.Formatear()
            actxnConsumoAddBlue.Text = _consumoaddblue : actxnConsumoAddBlue.Formatear()
            ...
            If IsNothing(managerAdministracionViajes.ListTRAN_Recibos) Then
                SetCarga(TipoCarga.Recibos,false) '======================================================================================
            End If
            ...
            '' Colocar Resultados
            _pendiente = _gastosiniciales - (_consumocombustible + _consumoaddblue + _gastos + _rec_egresos + _rec_egresosconductor + _rec_ingresos)
        ...
        Try
            ...
            Else
                ...
                If Not IsNothing(_validate.ListProcesos) Then
                    For Each item As ACSeguridad.EProcesos In _validate.ListProcesos
                        Select Case item.PROC_Codigo
                            Case Procesos.getProceso(Procesos.TipoProcesos.QuitarFlete) 'Proceso Eliminado --> PARA PROBAR EL BOTON 3005-2025FRANK
                                tsbtnFQuitar.Enabled = True
                            Case Procesos.getProceso(Procesos.TipoProcesos.ModFecComCombustible)
                                tsbtnCModificar.Enabled = True
                                tsbtnCModificar.Visible = True
    ...
    Private Function grabar() As Boolean
        Try
            ...
            managerTRAN_Viajes.TRAN_Viajes.VIAJE_KmTotal = Convert.ToDecimal(actxnKmDiferencia.Text) 'actxnKilometraje


            '''
            If Not managerTRAN_Viajes.TRAN_Viajes.TRAN_ViajesVehiculos.VEHIC_Id Then
                managerTRAN_Viajes.TRAN_Viajes.TRAN_ViajesVehiculos.VEHIC_Id = txtVehCodigo.Text
            End If
            'managerTRANViajes.setTRAN_Viajes(managerTRAN_Viajes.TRAN_Viajes)
    ...
    Private Sub acTool_ACBtnAnular_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles acTool.ACBtnAnular_Click
        Try
            If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Anular Registro: {0}", Me.Text) _
                , String.Format("Desea Anular el Viaje {0} - {1}: ", CType(bs_tran_viajes.Current, ETRAN_Viajes).VIAJE_Id,
...
#End Region
        ...
        Try
            Select Case sender.SelectedTab.Name.ToString()
                ...
                Case "tpgConsCombustible"
                    SetCarga(TipoCarga.ConsCombustible)
                Case "tpgConsumoAdBlue"
                    SetCarga(TipoCarga.ConsumoAdBlue)
                Case "tpgGastos"
    ...
    Private Sub actxnKmAnterior_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            If Not IsNothing(managerTRAN_Viajes.TRAN_Viajes) Then
                Dim x_topemantenimiento As Decimal = CType(bs_tran_viajes.Current, ETRAN_Viajes).VIAJE_MantenimientoKM
                ...
                CalcularProximo_MantenimientoKM(Convert.ToDecimal(actxnKilometraje.Text), x_topemantenimiento)
                actxnKmDiferencia.Text = managerTRAN_Viajes.TRAN_Viajes.TRAN_ViajesVehiculos.Diferencia
                '''
    ...
    Private Sub btnModVehiculo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModVehiculo.Click
        Try
            Try
                AyudaVehiCond(String.Empty, "VEHIC_Placa")
            Catch ex As Exception
        ...
        Try
            If managerTRAN_VehiculosConductores.CargarAyuda(x_cadena, x_campo) Then
                ...
                If Ayuda.ShowDialog() = Windows.Forms.DialogResult.OK Then
                    ...
                    ' MessageBox.Show("TXTVEHCODIGO")
                    txtVehCodigo.Text = Ayuda.Respuesta.Rows(0)("Cod. Vehiculo").ToString()
                    ' globales_.v_vehiculo_id = txtVehCodigo.Text
                    ...
                    'Update en base al Viaje busco por viajes y actualizo las  bY FRANK PORQUE EN LA Vehiculos Ranfla no se actual TRAN_ViajesVehiculos  en 
                    'Dim x_where_ViajesVehiculos As New Hashtable()
                    'managerTRAN_ViajesVehiculos = New BTRAN_ViajesVehiculos
                    'x_where_ViajesVehiculos.Add("VIAJE_Id", New ACWhere(managerTRAN_Viajes.TRAN_Viajes.VIAJE_Id, ACWhere.TipoWhere.Igual))
                    'If (managerTRAN_ViajesVehiculos.Cargar(x_where_ViajesVehiculos)) Then
                    '    managerTRAN_ViajesVehiculos.TRAN_ViajesVehiculos.Instanciar(ACEInstancia.Modificado)
                    '    managerTRAN_ViajesVehiculos.TRAN_ViajesVehiculos.VEHIC_Id = _btran_vehiculos.TRAN_Vehiculos.VEHIC_Id

                    'mi solucion era que en la TRAN_VehiculsoRanflas se extraida la informacion de hay cuand o se acutalize y por la columnas VEHRN_Id => 
                    'se actualize el VEHRN_id en el viaje para que amarre bien eso ...y el TranVEHICULOViajes tambien en la placa  ojo frank terminalo no seas vago 
                    'If (managerTRAN_ViajesVehiculos.GuardarTranViajes(GApp.Usuario)) Then
                    '    managerTRAN_Viajes.TRAN_Viajes.Instanciar(GApp.Usuario)
                    'End If
                    ''Actualiamos el viajes en la columnas VERN_ID 
                    'If (managerTRAN_Viajes.Guardar(GApp.Usuario)) Then
                    'End If
                    'End If
...
#Region " Cargar Datos: Fletes"
    ...
    Private Sub formatearGrilla_Fletes()
        Try
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdFletes, index, "R.U.C.", "ENTID_NroDocumento", "ENTID_NroDocumento", 250, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdFletes, index, "Cliente", "ENTID_Nombres", "ENTID_Nombres", 250, True, False, "System.String", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdFletes, index, "Moneda", "TIPOS_TipoMoneda", "TIPOS_TipoMoneda", 150, True, False, "System.String", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdRutas, index, "R.U.C.", "ENTID_NroDocumento", "ENTID_NroDocumento", 250, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdRutas, index, "Cliente", "ENTID_Nombres", "ENTID_Nombres", 250, True, False, "System.String", String.Empty) : index += 1
    ...
    Private Sub tsbtnDelFlete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbtnFQuitar.Click
        Try
            If CType(bs_tran_fletes.DataSource, List(Of ETRAN_Fletes)).Count > 0 Then
                ...
                'PROCESO AL QUITAR FLETE DEL VIAJE
                Dim _fletes As New BTRAN_Fletes
                Dim _where As New Hashtable
                _where.Add("FLETE_Id", New ACWhere(CType(bs_tran_fletes.Current, ETRAN_Fletes).FLETE_Id))
                _where.Add("FLETE_Estado", New ACWhere("C", ACWhere.TipoWhere.Igual))
                If _fletes.CargarTodos(_where) Then
                    GApp.DataUsuario.PROC_Codigo = Procesos.getProceso(Procesos.TipoProcesos.ModFletefacturado)
                    _validate = New ACValidarUsuario(GApp.DataConexion, GApp.DataUsuario, ACValidarUsuario.Operacion.ValidarProceso)
                    If Not _validate.ACProceso Then
                        Throw New Exception("No se Puede Quitar el Flete porque ya esta Cancelado")
                    End If
...
#Region " Cargar Datos: Neumaticos "
    Private Sub formatearGrilla_Neumaticos()
        Try
            Dim index As Integer = 1
            ACFrameworkC1.ACUtilitarios.ACFormatearGrilla(c1grdInvNeumaticos, 1, 1, 8, 1, 0)
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdInvNeumaticos, index, "KmUtilNeumatico", "KMVidaUtil", "KMVidaUtil", 250, True, False, "System.Decimal") : index += 1
    ...
    Private Sub cargarNeumaticos()
        Try
            ...
            If Not m_neumaticos Then
                ...
                ' Dim x_vehic_placa As String = "V9J-723"
                'managerAdministracionViajes.CargarNeumaticos(x_vehic_placa)
                managerAdministracionViajes.CargarNeumaticos(managerTRAN_Viajes.TRAN_Viajes.VIAJE_Id) 'aca tendria que ir el id de

                ' managerAdministracionViajes.CargarNeumaticos(managerTRAN_Vehiculos.TRAN_Vehiculos.VEHIC_Placa)
                ...
                '  MessageBox.Show("cargarNeumaticos ")
                globales_.v_vehiculo_id = managerTRAN_Vehiculos.TRAN_Vehiculos.VEHIC_Id
                m_neumaticos = True
...
#Region " Cargar Datos: Recibos "
    Private Sub formatearGrilla_Recibos()
        Try
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdIngEgre, index, "Codigo", "Codigo", "Codigo", 300, True, True, "System.String", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdIngEgre, index, "Tipo Recibo", "TIPOS_TipoRecibo", "TIPOS_TipoRecibo", 300, True, True, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdIngEgre, index, "Moneda", "TIPOS_TipoMoneda", "TIPOS_TipoMoneda", 300, True, True, "System.String", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdIngEgre, index, "Recibido de", "RECIB_De", "RECIB_De", 300, True, True, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdIngEgre, index, "Concepto", "RECIB_Concepto", "RECIB_Concepto", 300, True, True, "System.String", String.Empty) : index += 1
        ...
        Try
            If Not IsNothing(bs_tran_recibos) Then
                If Not IsNothing(bs_tran_recibos.Current) Then
                    If CType(bs_tran_recibos.Current, ETRAN_Recibos).TIPOS_CodTipoRecibo = ETipos.getTipo(ETipos.TipoRecibo.Pendiente) Or
...
#Region " Cargar Datos: Gasto Inicial "
    Private Sub formatearGrilla_GastosViajeInicial()
        Try
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGastoInicial, index, "Recibo", "Documento", "Documento", 300, True, True, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGastoInicial, index, "Tipo", "TIPOS_TipoDocumento", "TIPOS_TipoDocumento", 300, True, True, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGastoInicial, index, "Descripción", "CAJA_Glosa", "CAJA_Glosa", 300, True, True, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGastoInicial, index, "Moneda", "TIPOS_TipoMoneda", "TIPOS_TipoMoneda", 300, True, True, "System.String", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGastoInicial, index, "Fecha", "CAJA_Fecha", "CAJA_Fecha", 300, True, True, "System.String", String.Empty) : index += 1
...
#Region " Cargar Datos: Consumo de Combustible"
    Private Sub formatearGrilla_ConsCombustible()
        Try
            ...
            '' Conbustible Consumo
            index = 1
            ACFrameworkC1.ACUtilitarios.ACFormatearGrilla(c1grdConsCombustible, 1, 1, 17, 1, 0)
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsCombustible, index, "Codigo", "COMCO_Id", "COMCO_Id", 150, True, False, "System.Integer", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsCombustible, index, "Recibo", "Documento", "Documento", 150, True, False, "System.Integer", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsCombustible, index, "Referencia", "Referencia", "Referencia", 150, True, False, "System.Integer", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsCombustible, index, "R.U.C.", "ENTID_CodigoProveedor", "ENTID_CodigoProveedor", 150, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsCombustible, index, "Proveedor", "ENTID_RazonSocial", "ENTID_RazonSocial", 150, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsCombustible, index, "Modo Pago", "TIPOS_ModoPago", "TIPOS_ModoPago", 150, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsCombustible, index, "T. Combustible", "TIPOS_TipoCombustible", "TIPOS_TipoCombustible", 150, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsCombustible, index, "Moneda", "TIPOS_TipoMoneda", "TIPOS_TipoMoneda", 150, True, False, "System.String", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsCombustible, index, "Documento", "CompDocumento", "CompDocumento", 150, True, False, "System.String", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsCombustible, index, "Codigo Vale", "COMCO_CodigoVale", "COMCO_CodigoVale", 150, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsCombustible, index, "Considerar en Caja", "COMCO_CCaja", "COMCO_CCaja", 150, True, False, "System.Boolean", String.Empty) : index += 1
    ...
    Private Sub tsbtnCCQuitar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbtnCCQuitar.Click
        '    MessageBox.Show("ME PRESIONASTE ? ")
        Try
            If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Eliminar el consumo de combustible: {0}", Me.Text) _
                ...
                managerAdministracionViajes.eliminarSoloConsCombustible()
                ACControles.ACDialogos.ACMostrarMensajeSatisfactorio(String.Format("Información: {0}", Me.Text), "Eliminado satisfactoriamente")
                cargarIncidenciasViaje()
                calcular(TipoCarga.ConsCombustible)
                SetCarga(TipoCarga.ConsCombustible)
...
#Region " Cargar Datos: Consumo de AdBlue"
    Private Sub formatearGrilla_ConsumoAdBlue()
        Try
            Dim index As Integer = 1
            'Definicion de grilla de Ingresos
            '' Consumo AdBlue
            index = 1
            ACFrameworkC1.ACUtilitarios.ACFormatearGrilla(c1grdConsumoAdBlue, 1, 1, 18, 1, 0)
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Codigo", "COMCO_Id", "COMCO_Id", 150, True, False, "System.Integer", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Codigo Vale", "COMCO_CodigoVale", "COMCO_CodigoVale", 150, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "R.U.C.", "ENTID_CodigoProveedor", "ENTID_CodigoProveedor", 150, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Proveedor", "ENTID_RazonSocial", "ENTID_RazonSocial", 150, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Litros (Lts)", "COMCO_LitrosConsumidos", "COMCO_LitrosConsumidos", 150, True, False, "System.Decimal", Parametros.GetParametro(EParametros.TipoParametros.pg_FMondo4d)) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Consumo (Gls)", "COMCO_GalonesConsumidos", "COMCO_GalonesConsumidos", 150, True, False, "System.Decimal", Parametros.GetParametro(EParametros.TipoParametros.pg_FMondo4d)) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Fecha", "COMCO_Fecha", "COMCO_Fecha", 150, True, False, "System.DateTime", Parametros.GetParametro(EParametros.TipoParametros.pg_FormatoFecha)) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Recibo", "Documento", "Documento", 150, True, False, "System.Integer", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Referencia", "Referencia", "Referencia", 150, True, False, "System.Integer", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Modo Pago", "TIPOS_ModoPago", "TIPOS_ModoPago", 150, True, False, "System.String", String.Empty) : index += 1
            'ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "T. Combustible", "TIPOS_TipoCombustible", "TIPOS_TipoCombustible", 150, True, False, "System.String", "") : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Moneda", "TIPOS_TipoMoneda", "TIPOS_TipoMoneda", 150, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Prec. Galon", "COMCO_PrecioGalon", "COMCO_PrecioGalon", 150, True, False, "System.Decimal", Parametros.GetParametro(EParametros.TipoParametros.pg_FMondo2d)) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Prec. Total", "COMCO_Total", "COMCO_Total", 150, True, False, "System.Decimal", Parametros.GetParametro(EParametros.TipoParametros.pg_FMondo2d)) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Fecha Viaje", "COMCO_FechaViaje", "COMCO_FechaViaje", 150, True, False, "System.DateTime", Parametros.GetParametro(EParametros.TipoParametros.pg_FormatoFecha)) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Documento", "CompDocumento", "CompDocumento", 150, True, False, "System.String", String.Empty) : index += 1


            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConsumoAdBlue, index, "Considerar en Caja", "COMCO_CCaja", "COMCO_CCaja", 150, True, False, "System.Boolean", String.Empty) : index += 1

            c1grdConsumoAdBlue.AllowEditing = False
            c1grdConsumoAdBlue.Styles.Alternate.BackColor = Color.WhiteSmoke
            c1grdConsumoAdBlue.Styles.Fixed.TextAlign = TextAlignEnum.CenterCenter
            c1grdConsumoAdBlue.Styles.Highlight.BackColor = Color.Gray
            c1grdConsumoAdBlue.SelectionMode = SelectionModeEnum.Row
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    'Private Sub cargarConsumoAdBlue()
    '    Try
    '        '' Cargar el consumo de combustible asociado
    '        If Not managerAdministracionViajes.cargarConsumoAdBlue(managerTRAN_Viajes.TRAN_Viajes.VIAJE_Id) Then

    '            'poNEMOS ESTO PORQUE CUANDO MANDA NULLO EL CURREN DE COMCO_ID SALE ERROR ENTONCES ESTO ES PARA 
    '            'DARLE UN VALOR IMAGINARIO

    '            managerAdministracionViajes.ListTRAN_CombustibleConsumo = New List(Of ETRAN_CombustibleConsumo)
    '        End If
    '        bs_tran_consumoadblue = New BindingSource()
    '        bs_tran_consumoadblue.DataSource = managerAdministracionViajes.ListTRAN_CombustibleConsumo

    '        c1grdConsumoAdBlue.DataSource = bs_tran_consumoadblue
    '        bnavConsumoAdBlue.BindingSource = bs_tran_consumoadblue
    '        managerAdministracionViajes.setTRAN_CombustibleADblue(CType(bs_tran_consumoadblue.Current, ETRAN_CombustibleConsumo).COMCO_Id)

    '        c1grdConsumoAdBlue.Subtotal(AggregateEnum.Sum, 0, -1, 5, "Total")
    '        c1grdConsumoAdBlue.Subtotal(AggregateEnum.Sum, 0, -1, 12, "Total")
    '    Catch ex As Exception
    '        Throw ex
    '    End Try
    'End Sub
    Private Sub cargarConsumoAdBlue()
        Try
            ...
            If Not managerAdministracionViajes.cargarConsumoAdBlue(managerTRAN_Viajes.TRAN_Viajes.VIAJE_Id) Then
                'poNEMOS ESTO PORQUE CUANDO MANDA NULLO EL CURREN DE COMCO_ID SALE ERROR ENTONCES ESTO ES PARA 
                'DARLE UN VALOR IMAGINARIO 'NO CREO CHOLITO ..JJAJAJ FRNAK  ..> 06-11-2025
                managerAdministracionViajes.ListTRAN_CombustibleConsumo = New List(Of ETRAN_CombustibleConsumo)
            End If
            ...
            ' Verificar si hay algún registro antes de intentar acceder al registro actual
            If bs_tran_consumoadblue.Current IsNot Nothing AndAlso TypeOf bs_tran_consumoadblue.Current Is ETRAN_CombustibleConsumo Then
                managerAdministracionViajes.setTRAN_CombustibleADblue(CType(bs_tran_consumoadblue.Current, ETRAN_CombustibleConsumo).COMCO_Id)
            End If
    ...
    Private Sub tsbtnCABAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbtnCABAgregar.Click
        Try
            'Dim frmCAdBlue As New PConsumoAdBlue(managerTRAN_Viajes.TRAN_Viajes.VIAJE_Id, m_tran_vehiculos.VEHIC_Id, Date.Now)
            '  m_tran_vehiculos = managerTRAN_Vehiculos.getTRAN_Vehiculos()
            ' ABVehiculo()

            Dim frmCAdBlue As New PConsumoAdBlue(managerTRAN_Viajes.TRAN_Viajes.VIAJE_Id, managerTRAN_Vehiculos.TRAN_Vehiculos.VEHIC_Id, Date.Now)
            If frmCAdBlue.ShowDialog() = Windows.Forms.DialogResult.OK Then
                SetCarga(TipoCarga.ConsumoAdBlue)
                calcular(TipoCarga.ConsumoAdBlue)
            End If
        Catch ex As Exception
            ACControles.ACDialogos.ACMostrarMensajeError(String.Format("Error: {0}", Me.Text), "Ocurrio un error en el proceso Agregar Consumo de Combustible", ex)
        End Try
...
#Region " Cargar Datos: Gastos de Viaje "
    Private Sub formatearGrilla_Gastos()
        ...
        Try
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGastViajes, index, "Codigo", "VGAST_Id", "VGAST_Id", 150, True, False, "System.Integer", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGastViajes, index, "Tipo Gasto", "TIPOS_TipoGasto", "TIPOS_TipoGasto", 150, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGastViajes, index, "Moneda", "TIPOS_TipoMoneda", "TIPOS_TipoMoneda", 150, True, False, "System.String", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGastViajes, index, "Descripción", "VGAST_Descripcion", "VGAST_Descripcion", 250, True, False, "System.String", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGastViajes, index, "Documento", "Documento", "Documento", 150, True, False, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGastViajes, index, "Proveedor", "ENTID_RazonSocial", "ENTID_RazonSocial", 150, True, False, "System.String", String.Empty) : index += 1
    ...
    Private Sub tsbtnGVModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbtnGVModificar.Click
        Try
            Dim frmGViajes As New PGastosViaje(CType(bs_tran_viajesgastos.Current, ETRAN_ViajesGastos).VGAST_Id, managerTRAN_Viajes.TRAN_Viajes.VIAJE_Id,
                                               managerTRAN_Viajes.TRAN_Viajes.VIAJE_FecSalida, CType(bs_tran_viajesgastos.Current, ETRAN_ViajesGastos).RECIB_Codigo,
...
#Region " Guias de Remision "
    Private Sub formatearGrilla_GuiasRemision()
        Try
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGuiaRemision, index, "Codigo", "GTRAN_Codigo", "GTRAN_Codigo", 50, False, False, "System.Integer", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGuiaRemision, index, "Serie", "Serie", "Serie", 30, True, True, "System.String", String.Empty) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdGuiaRemision, index, "Numero", "Numero", "Numero", 80, True, True, "System.Integer", String.Empty) : index += 1
...
#Region " Reporte "
    Private Sub reporteIE(ByVal x_preview As Boolean)
        ...
        Try
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdResGastos, index, "Descripción", "Descripcion", "Descripcion", 100, True, False, "System.String", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdResumen, index, "Descripción", "Descripcion", "Descripcion", 100, True, False, "System.String", String.Empty) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdConductor, index, "Descripción", "Descripcion", "Descripcion", 300, True, False, "System.String", String.Empty) : index += 1
            ...
            Dim x As New ACPreview(m_listFlex, New ACCabecera(New ACTexto("Reporte de Viajes", New Font(Me.Font.FontFamily, 14, FontStyle.Bold)), GApp.ESucursal.SUCUR_Nombre, String.Empty, _sub, New Font(Me.Font.FontFamily, 8, FontStyle.Bold)))
    ...
    Private Sub reporteInv(ByVal x_preview As Boolean)
        Try
            ...
            Dim x As New ACPreview(m_listFlex, New ACCabecera(New ACTexto("Reporte de Viajes", New Font(Me.Font.FontFamily, 14, FontStyle.Bold)), GApp.ESucursal.SUCUR_Nombre, String.Empty, _sub, New Font(Me.Font.FontFamily, 11, FontStyle.Bold)))
...
#Region " Docking "
    ...
    Private Sub InitDocket()
        ...
        Dim wc As WindowContent = m_dockingManager.AddContentWithState(cA, Crownwood.DotNetMagic.Docking.State.DockRight)
...
#End Region
    ...
    Private Sub actsbtnQuitarAnulado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles actsbtnQuitarAnulado.Click
        Try
            If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Activar Registro Anulado: {0}", Me.Text) _
                , String.Format("Desea Activar el Registro de Viaje Anulado: {0} - {1}: ", CType(bs_tran_viajes.Current, ETRAN_Viajes).VIAJE_Id,
                                CType(bs_tran_viajes.Current, ETRAN_Viajes).VIAJE_Descripcion) _
                , ACControles.ACDialogos.LabelBotom.Si_No) = DialogResult.Yes Then
                managerTRAN_Viajes.TRAN_Viajes = CType(bs_tran_viajes.Current, ETRAN_Viajes)
    ...
    Private Sub acTool_ACBtnEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles acTool.ACBtnEliminar_Click
        Try
            If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Eliminar Registro de Viaje: {0}", Me.Text) _
                , String.Format("Desea Eliminar el Registro de Viaje: {0} - {1}: ", CType(bs_tran_viajes.Current, ETRAN_Viajes).VIAJE_Id,
                                CType(bs_tran_viajes.Current, ETRAN_Viajes).VIAJE_Descripcion) _
                            , "Esta operación eliminara todos los registros del viaje, incluyendo los registros anexos" _
                            , ACControles.ACDialogos.LabelBotom.Si_No) = DialogResult.Yes Then
                If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Eliminar Registro de Viaje: {0}", Me.Text) _
                 , String.Format("Confirmar Eliminación del Viaje: {0} - {1}: ", CType(bs_tran_viajes.Current, ETRAN_Viajes).VIAJE_Id,
                                 CType(bs_tran_viajes.Current, ETRAN_Viajes).VIAJE_Descripcion) _
                             , ACControles.ACDialogos.LabelBotom.Si_No) = DialogResult.Yes Then
                    managerTRAN_Viajes.TRAN_Viajes = CType(bs_tran_viajes.Current, ETRAN_Viajes)
    ...
    Private Sub tsbtnImprimir_Click(sender As Object, e As EventArgs) Handles tsbtnImprimir.Click
        Try
            If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Imprimir Registro: {0}", Me.Text) _
                ...
                If _Imprimir.Print_Recibos(CType(bs_tran_recibos.Current, ETRAN_Recibos).RECIB_Codigo, PrintDocument1) Then
    ...
    Private Sub tsbtnImprimirRec_Click(sender As Object, e As EventArgs) Handles tsbtnImprimirRec.Click
        Try
            ...
            If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Imprimir Registro: {0}", Me.Text) _
                ...
                If _Imprimir.Print_Recibos(x_recibo, PrintDocument1) Then
                    ACControles.ACDialogos.ACMostrarMensajeSatisfactorio(String.Format("Información: {0}", Me.Text), "Impreso Satisfactoriamente")
                    tsbtnImprimir.Enabled = m_reimprimir
                    cargarRecibos()
                End If
    ...
    Private Sub ToolStripButton52_Click(sender As Object, e As EventArgs) Handles ToolStripButton52.Click
        Try
            Utilitarios.ExportarXLS(c1grdBusqueda, "Viajes")
        Catch ex As Exception
        ...
        End Try
    End Sub
    Private Sub tsbtnCABModificar_Click(sender As Object, e As EventArgs) Handles tsbtnCABModificar.Click
        Try
            bs_tran_combustibleconsumo = New BindingSource()
            bs_tran_combustibleconsumo.DataSource = managerAdministracionViajes.ListTRAN_CombustibleConsumo
            Dim frmCC As New PConsumoCombustible(CType(bs_tran_combustibleconsumo.Current, ETRAN_CombustibleConsumo).COMCO_Id)
    ...
    Private Sub ToolStripLabel15_Click(sender As Object, e As EventArgs) Handles ToolStripLabel15.Click
        Try
            'BOTON PARA ELIMINAR SOLO EL CONSUMO 
            If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Eliminar EL consumo ?  {0}", Me.Text) _
                , String.Format("Desea Eliminar el Consumo  de AdBLue {0} -del VIaje {1}: ", CType(bs_tran_consumoadblue.Current, ETRAN_CombustibleConsumo).COMCO_Id,
                                CType(bs_tran_viajes.Current, ETRAN_Viajes).VIAJE_Descripcion) _
                            , ACControles.ACDialogos.LabelBotom.Si_No) = DialogResult.Yes Then
                managerAdministracionViajes.setTRAN_CombustibleADblue(CType(bs_tran_consumoadblue.Current, ETRAN_CombustibleConsumo).COMCO_Id)
                'cargarConsumoAdBlue()

                If managerAdministracionViajes.EliminarConsumoADBlue() Then 'Creado Frank 
                    ACControles.ACDialogos.ACMostrarMensajeSatisfactorio(String.Format("Información: {0}", Me.Text), "Eliminado satisfactoriamente")
                    btnConsultar_Click(Nothing, Nothing)
                    bs_tran_viajes_CurrentChanged(Nothing, Nothing)
                    'VOlvemos a cargar si hay mas de 1 consumo de combustible 
                    cargarConsumoAdBlue()
                End If
            End If

        Catch ex As Exception
            ACControles.ACDialogos.ACMostrarMensajeInformacion(String.Format("{0}", Me.Text), "No Hay mas Vales de Combustibles")
            ' ACControles.ACDialogos.ACMostrarMensajeError(String.Format("Error: {0}", Me.Text), "Ocurrio un error en el proceso Eliminar Viaje", ex)
        End Try
    End Sub
    ...
    Private Sub tcnDetalle_SelectionChanged(sender As TabControl, oldPage As TabPage, newPage As TabPage) Handles tcnDetalle.SelectionChanged
        '
        'Dim tabName As String = tcnDetalle.SelectedTab.Name

        If (tcnDetalle.SelectedIndex = 1) Then

         '   RecibeParametrosParaControlarTabConsumoCombustible(TipoCarga.ConsCombustible)
                        globales_.x_BanderaTabControlCombustible  = True 
                  globales_.x_BanderaTabControlAdBlue  = False
        Else If (tcnDetalle.SelectedIndex = 2)
                         globales_.x_BanderaTabControlAdBlue  = True 
            globales_.x_BanderaTabControlCombustible = false
            'RecibeParametrosParaControlarTabConsumoCombustible(TipoCarga.ConsumoAdBlue)
        Else
                           globales_.x_BanderaTabControlCombustible  = False 
                  globales_.x_BanderaTabControlAdBlue  = False
        ...
        '   '    Case Else
        '   '        ' Si no coincide con ninguno, no muestra nada
        '   'End Select
    End Sub

    Private Function RecibeParametrosParaControlarTabConsumoCombustible(ByVal x_opcion As TipoCarga) 
        Select x_opcion 
            Case TipoCarga.ConsCombustible 
               ' globales_.x_BanderaTabControlCombustible = True
                'globales_.x_BanderaTabControlAdBlue = False
                'globales_.x_BanderGrabarAdBlue = False 
                CambiarTabRecibeParametrosControlCombustible()
                Case TipoCarga.ConsumoAdBlue
                'globales_.x_BanderaTabControlCombustible  = False
                'globales_.x_BanderaTabControlAdBlue = True
    ...
    Private Function CambiarTabRecibeParametrosControlCombustible()
        If (globales_.x_BanderaTabControlCombustible And globales_.x_BanderGrabarCombustible  = True  ) Then 
            tcnDetalle.SelectedTab = tpgConsCombustible
            Else If (globales_.x_BanderaTabControlAdBlue And globales_.x_BanderGrabarAdBlue = true ) tHEN  
            tcnDetalle.SelectedTab = tpgConsumoAdBlue
            Else 
            'Nada 
        End If
