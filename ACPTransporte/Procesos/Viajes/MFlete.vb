   ...
   Private Sub setInicio(ByVal x_tran_fletes As ETRAN_Fletes)
      Try
         ...
         If managerTRAN_Rutas.Cargar(_join, _where) Then
                managerTRAN_Fletes.TRAN_Fletes.Ubigo_CodOrigen = managerTRAN_Rutas.TRAN_Rutas.UBIGO_CodOrigen
                managerTRAN_Fletes.TRAN_Fletes.Ubigo_CodDestino = managerTRAN_Rutas.TRAN_Rutas.UBIGO_CodDestino
                txtOrigen.Text = managerTRAN_Fletes.TRAN_Fletes.Ubigo_CodOrigen
                txtUbiOrigen.Text = managerTRAN_Rutas.TRAN_Rutas.UBIGO_CodOrigen
                txtDestino.Text = managerTRAN_Fletes.TRAN_Fletes.Ubigo_CodDestino
            ...
            actxnIGV.Enabled = x_tran_fletes.FLETE_ImporteIgv > 0
                ...
                actxnValorReferencialXTm.Text = x_tran_fletes.FLETE_ValorReferencial
                actxnTotalValorReferencial.Text = x_tran_fletes.FLETE_TotalValorReferencial
         End If
         Me.KeyPreview = True
      Catch ex As Exception
         Throw ex
      ...
      Try
         If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Grabar Registro: {0}", Me.Text) _
             ...
             , ACControles.ACDialogos.LabelBotom.Si_No) = DialogResult.Yes Then
                ...
                managerTRAN_Fletes.TRAN_Fletes.FLETE_ImporteIgv = Convert.ToDecimal(actxnIGV.Text)
                ...
                managerTRAN_Fletes.TRAN_Fletes.FLETE_ValorReferencial = actxnValorReferencialXTm.Text
                managerTRAN_Fletes.TRAN_Fletes.FLETE_TotalValorReferencial = actxnTotalValorReferencial.Text
                managerTRAN_Fletes.TRAN_Fletes.Instanciar(ACEInstancia.Modificado)
