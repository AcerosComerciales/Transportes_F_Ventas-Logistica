...
#End Region
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        Dim fGuiaTransportistaDetalle As New FGuiaTransportistaDetalle()
        fGuiaTransportistaDetalle.StartPosition = FormStartPosition.CenterScreen
        If fGuiaTransportistaDetalle.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ' Ingresar funcionalidad que inserta objeto con datos para Guia Transportista Detalle
        End If
    End Sub
End Class