   ...
   Private Sub setCotizToFactura(ByVal x_cotiz_codigo As String)
      Try
         If managerTRAN_Cotizaciones.Cargar(x_cotiz_codigo, True) Then
            ...
            actxaFleteDesc.Text = managerTRAN_Cotizaciones.TRAN_Cotizaciones.RUTAS_Nombre
...
#Region " Ayudas "
   ...
   Private Sub actxaFlete_ACAyudaClick(ByVal sender As System.Object, ByVal e As System.EventArgs)
      Try
         Dim _frm As New CFletes("", CFletes.TAyuda.RazonSocial)
         If _frm.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            If managerFletes.Cargar(_frm.TRAN_Fletes.FLETE_Id) Then
               actxaFleteDesc.Text = managerFletes.TRAN_Fletes.FLETE_NombreRuta

               managerFletes.TRAN_Fletes.ENTID_NroDocumento = managerFletes.TRAN_Fletes.ENTID_Codigo.Substring(1)
...
#Region " ToolBox "
   Private Sub acTool_ACBtnAnular_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles acTool.ACBtnAnular_Click
      Try
         If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Eliminar Documento de Venta: {0}", Me.Text) _
            ...
            If managerGenerarDocsVenta.AnularDocumento(CType(bs_documentos.Current, EVENT_DocsVenta), managerGenerarDocsVenta.TRAN_Cotizaciones.COTIZ_Codigo, GApp.Usuario) Then
   ...
   Private Sub acTool_ACBtnGrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles acTool.ACBtnGrabar_Click
      ...
      x_bauditoria.Autorizacion = False
      Try
         If Not IsNothing(managerGenerarDocsVenta.VENT_DocsVenta) Then
            If Validar(m_msg) Then
               ...
               If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Generar Documento de Venta: {0}", Me.Text) _
                  ...
                  If managerGenerarDocsVenta.generarDocumento(GApp.Usuario, actxaCotiz.Text, dtpFecFacturacion.Value, CType(bs_series.Current, EVENT_PVentDocumento).PVDOCU_Serie, x_numero, cmbEntrega.SelectedValue, m_msg, x_bauditoria) Then
                     If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Imprimir Documento de Venta: {0}", Me.Text) _
                        ...
                        Try
                           If _print.Print_FacturaTransportista(managerGenerarDocsVenta.VENT_DocsVenta.DOCVE_Codigo, managerGenerarDocsVenta.VENT_DocsVenta.DOCVE_Serie,True) Then
   ...
   Private Sub acTool_ACBtnImprimir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles acTool.ACBtnImprimir_Click
      Try
         ...
         If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Imprimir Factura: {0}", Me.Text) _
             ...
             , ACControles.ACDialogos.LabelBotom.Si_No) = DialogResult.Yes Then
            Dim _print As New Impresion(tscmbImpresora.Text)
            If _print.Print_FacturaTransportista(x_docve_codigo, x_serie,True) Then
