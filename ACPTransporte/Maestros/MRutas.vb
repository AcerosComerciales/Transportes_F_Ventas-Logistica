   ...
   Private Sub formatearGrilla()
      ...
      Try
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Destino", "UBIGO_DESTINO", "UBIGO_DESTINO", 150, True, False, "System.String", "") : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Valor Referencial", "RUTAS_ValorReferencial", "RUTAS_ValorReferencial", 150, True, False, "System.String", "") : index += 1
   ...
   Private Sub AsignarBinding()
      Try
         ...
         m_listBindHelper.Add(ACBindHelper.ACBind(actxnDistancia, "Text", m_etran_rutas, "RUTAS_Km"))
            ...
            m_listBindHelper.Add(ACBindHelper.ACBind(actxnValorReferencial, "Text", m_etran_rutas, "RUTAS_ValorReferencial"))
      ...
      Try
         If managerTRAN_Rutas.Cargar(x_codigo, True) Then
            ...
            txtOrigen.Text = managerTRAN_Rutas.TRAN_Rutas.UBIGO_Origen
                ...
                actxnValorReferencial.Text = managerTRAN_Rutas.TRAN_Rutas.RUTAS_ValorReferencial
            AsignarBinding()
            tabMantenimiento.SelectedTab = tabDatos
