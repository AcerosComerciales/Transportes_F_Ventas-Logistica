...
Public Class CRCuadreCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPTransportes.CRCuadreCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCuadreCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCuadreCaja = New CRCuadreCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
