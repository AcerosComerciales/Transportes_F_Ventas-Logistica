...
Public Class CRGuiasCemento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPTransportes.CRGuiasCemento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRGuiasCemento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRGuiasCemento = New CRGuiasCemento()
        rpt.Site = Me.Site
        Return rpt
    End Function
