...
Public Class CRFacturaJRA001
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPTransportes.CRFacturaJRA001.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRFacturaJRA001
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRFacturaJRA001 = New CRFacturaJRA001()
        rpt.Site = Me.Site
        Return rpt
    End Function
