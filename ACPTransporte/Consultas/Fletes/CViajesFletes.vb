...
Public Class CViajesFletes
#Region "Variables"
   Private m_btran_fletes As ACBTransporte.BReporte
...
#Region "Contructores"
   Public Sub New()
      ...
      Try
         m_btran_fletes = New ACBTransporte.BReporte(GApp.PuntoVenta)
...
#Region "Metodos"
   ...
   Private Sub formatearGrilla()
      ...
      Try
         ACFrameworkC1.ACUtilitarios.ACFormatearGrilla(c1grdReporte, 1, 1, 15, 1, 0)
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "Viaje", "Documento", "Documento", 120, True, False, "System.String") : index += 1
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "Descripción", "VIAJE_Descripcion", "VIAJE_Descripcion", 90, True, False, "System.String") : index += 1
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "Fec. Salida", "FLETE_FecSalida", "FLETE_FecSalida", 90, True, False, "System.DateTime", Parametros.GetParametro(ACEVentas.EParametros.TipoParametros.pg_FormatoFecha)) : index += 1
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "Fec. Llegada", "FLETE_FecLlegada", "FLETE_FecLlegada", 90, True, False, "System.DateTime", Parametros.GetParametro(ACEVentas.EParametros.TipoParametros.pg_FormatoFecha)) : index += 1
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "Por TM", "FLETE_MontoPorTM", "FLETE_MontoPorTM", 90, True, False, "System.Decimal", Parametros.GetParametro(ACEVentas.EParametros.TipoParametros.pg_FMondo2d)) : index += 1
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "I.G.V.", "FLETE_ImporteIgv", "FLETE_ImporteIgv", 90, True, False, "System.Decimal", Parametros.GetParametro(ACEVentas.EParametros.TipoParametros.pg_FMondo2d)) : index += 1
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "Peso", "FLETE_PesoEnTM", "FLETE_PesoEnTM", 90, True, False, "System.Decimal", Parametros.GetParametro(ACEVentas.EParametros.TipoParametros.pg_FMondo4d)) : index += 1
...
#Region "Metodos de Controles"
   Private Sub c1grdReporte_OwnerDrawCell(ByVal sender As System.Object, ByVal e As C1.Win.C1FlexGrid.OwnerDrawCellEventArgs)
      Try
...
#End Region
   ...
   Private Sub btnProcesar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProcesar.Click
      ...
      Try
         ...
         If Not m_btran_fletes.REPORTE_ViajesFletes(AcFecha.ACDtpFecha_De.Value.Date, AcFecha.ACDtpFecha_A.Value.Date) Then
         ...
         c1grdReporte.AutoSizeCol(2)
         If chkAgruparEfectivo.Checked Then
            c1grdReporte.Subtotal(AggregateEnum.Sum, 1, 1, 11, "Viaje: {0}")
         End If
   ...
   Private Sub chkAgruparEfectivo_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkAgruparEfectivo.CheckedChanged
      If chkAgruparEfectivo.Checked Then
         c1grdReporte.Subtotal(AggregateEnum.Sum, 1, 1, 11, "Total Viaje Nro: {0}")
      Else
         c1grdReporte.Subtotal(AggregateEnum.Clear)
      End If
      c1grdReporte.AutoSizeCol(1)
      c1grdReporte.AutoSizeCol(3)
   End Sub
End Class