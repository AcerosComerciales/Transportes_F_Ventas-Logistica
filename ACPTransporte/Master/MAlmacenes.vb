...
#Region " Variables "
   Private managerBAlmacenes As BAlmacenes
...
#Region " Utilitarios "
   ...
   Private Sub formatearGrilla()
      ...
      Try
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Codigo", "ALMAC_Id", "ALMAC_Id", 150, True, False, "System.Integer", "") : index += 1
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Zona", "ZONAS_Codigo", "ZONAS_Codigo", 150, True, False, "System.String", "") : index += 1
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Descripción", "ALMAC_Descripcion", "ALMAC_Descripcion", 150, True, False, "System.String", "") : index += 1
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Dirección", "ALMAC_Direccion", "ALMAC_Direccion", 150, True, False, "System.String", "") : index += 1
   ...
   Private Sub cargarCombos()
      Try
         ...
         ACFramework.ACUtilitarios.ACCargaCombo(cmbTAlmacen, Colecciones.Tipos(ETipos.MyTipos.TipoAlmacen), "TIPOS_Descripcion", "TIPOS_Codigo")
         ACFramework.ACUtilitarios.ACCargaCombo(cmbZona, Colecciones.Zonas, "ZONAS_Descripcion", "ZONAS_Codigo")
      Catch ex As Exception
         Throw ex
      End Try
   End Sub
...
#Region " Cargar Datos "
   ...
   Private Sub cargarDatos()
      Try
         ...
         bs_almacenes.DataSource = managerBAlmacenes.getListAlmacenes()
         c1grdBusqueda.DataSource = bs_almacenes
         bnavBusqueda.BindingSource = bs_almacenes
      Catch ex As Exception
         Throw ex
      End Try
   End Sub
   ...
   Private Sub AsignarBinding()
      Try
         m_listBindHelper = New List(Of ACBindHelper)()
         m_listBindHelper.Add(ACBindHelper.ACBind(txtCodigo, "Text", m_ealmacen, "ALMAC_Id"))
         m_listBindHelper.Add(ACBindHelper.ACBind(cmbZona, "SelectedValue", m_ealmacen, "ZONAS_Codigo"))
         m_listBindHelper.Add(ACBindHelper.ACBind(cmbSucursal, "SelectedValue", m_ealmacen, "SUCUR_Id"))
         m_listBindHelper.Add(ACBindHelper.ACBind(cmbTAlmacen, "SelectedValue", m_ealmacen, "TIPOS_CodTipoAlmacen"))
         m_listBindHelper.Add(ACBindHelper.ACBind(txtDescripcion, "Text", m_ealmacen, "ALMAC_Descripcion"))
         m_listBindHelper.Add(ACBindHelper.ACBind(txtDireccion, "Text", m_ealmacen, "ALMAC_Direccion"))
      Catch ex As Exception
         Throw ex
      End Try
   End Sub
   ...
   Private Sub cargar()
      Try
         If bs_almacenes.Current IsNot Nothing Then
            Dim x_codigo As Integer = CType(bs_almacenes.Current, EAlmacenes).ALMAC_ID
            managerBAlmacenes.Cargar(x_codigo)
            m_ealmacen = managerBAlmacenes.getAlmacenes()
            AsignarBinding()
...
#End Region
   ...
   Private Function busqueda(ByVal x_cadena As String) As Boolean
      Try
         If managerBAlmacenes.Busqueda(x_cadena) Then
...
#Region "Procesos"
   Private Sub Ordenar(ByVal x_columna As String)
      Dim _ordenador As New ACOrdenador(Of EAlmacenes)
      Try
         If m_order = 2 Then x_columna += " DESC"
         _ordenador.ACOrdenamiento = x_columna
         CType(bs_almacenes.DataSource, List(Of EAlmacenes)).Sort(_ordenador)
...
#Region " Tool Bar "
   Private Sub acTool_ACBtnNuevo_Click(ByVal sender As Object, ByVal e As EventArgs) Handles acTool.ACBtnNuevo_Click
      Try
         tabMantenimiento.SelectedTab = tabDatos
         m_ealmacen = New EAlmacenes()
         m_ealmacen.Instanciar(ACEInstancia.Nuevo)
         setInstancia(ACFramework.ACUtilitarios.ACSetInstancia.Nuevo)
         AsignarBinding()
      Catch ex As Exception
         ACControles.ACDialogos.ACMostrarMensajeError(String.Format("Error: {0}", Text), "Ocurrio un error en el proceso Nuevo Almacen", ex)
      End Try
   End Sub
   ...
   Private Sub acTool_ACBtnCancelar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles acTool.ACBtnCancelar_Click
      Try
         ...
         Next
      Catch ex As Exception
         ACControles.ACDialogos.ACMostrarMensajeError(String.Format("Error: {0}", Text), "Ocurrio un error en el proceso Cancelar Almacen", ex)
      End Try
   End Sub
   ...
   Private Sub acTool_ACBtnModificar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles acTool.ACBtnModificar_Click
      Try
         ...
         tabMantenimiento.SelectedTab = tabDatos
      Catch ex As Exception
         ACControles.ACDialogos.ACMostrarMensajeError(String.Format("Error: {0}", Text), "Ocurrio un error en el proceso Modificar Almacen", ex)
      End Try
   End Sub

   Private Sub acTool_ACBtnGrabar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles acTool.ACBtnGrabar_Click
      Try
         managerBAlmacenes.setAlmacenes(m_ealmacen)
         If managerBAlmacenes.Guardar(GApp.Usuario) Then
   ...
   Private Sub acTool_ACBtnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles acTool.ACBtnEliminar_Click
      Try
         If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Eliminar Registro: {0}", Me.Text), String.Format("Desea eliminar el registro: {0}?", CType(bs_almacenes.Current, EAlmacenes).ALMAC_DESCRIPCION), ACControles.ACDialogos.LabelBotom.Si_No) = DialogResult.Yes Then
            m_ealmacen = CType(bs_almacenes.Current, EAlmacenes)
            m_ealmacen.Instanciar(ACEInstancia.Eliminado)
            managerBAlmacenes.setAlmacenes(m_ealmacen)
            managerBAlmacenes.Guardar(GApp.Usuario)
