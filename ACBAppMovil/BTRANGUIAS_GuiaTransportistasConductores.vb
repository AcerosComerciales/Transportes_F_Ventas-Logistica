...
Public Class BTRANGUIAS_GuiaTransportistasConductores



    '#Region " Variables "

    '    Private m_ETRANGUIAS_GuiaTransportistasConductores As ETRANGUIAS_GuiaTransportistasConductores
    '    Private m_listVENT_Pedidos As List(Of ETRANGUIAS_GuiaTransportistasConductores)
    '    Private m_dtVENT_Pedidos As DataTable

    '    Private m_dsVENT_Pedidos As DataSet
    '    Private d_vent_pedidos As DTRANGUIAS_GuiaTransportistasConductores
    ...
    '        m_listVENT_Pedidos = New List(Of ETRANGUIAS_GuiaTransportistasConductores)
    '        Try
    ...
    '                    m_ETRANGUIAS_GuiaTransportistasConductores.ListDetPedidos = New List(Of ETRANGUIAS_GuiaTransportistasConductoresDetalle)(m_bvent_pedidosdetalle.ListVENT_PedidosDetalle)
    '                End If
    '                Return True
    '            Else
    '                Return False
    ...
    '        Try
    '            For Each item As ETRANGUIAS_GuiaTransportistasConductores In m_listVENT_Pedidos
