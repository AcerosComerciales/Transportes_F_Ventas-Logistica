...
Public Class BTRANGUIAS_GuiaTransportistasDetalle
    '#Region " Variables "

    '    Private m_ETRANGUIAS_GuiaTransportistasDetalle As ETRANGUIAS_GuiaTransportistasDetalle
    '    Private m_listVENT_Pedidos As List(Of ETRANGUIAS_GuiaTransportistasDetalle)
    '    Private m_dtVENT_Pedidos As DataTable

    '    Private m_dsVENT_Pedidos As DataSet
    '    Private d_vent_pedidos As DTRANGUIAS_GuiaTransportistasDetalle
    ...
    '        m_listVENT_Pedidos = New List(Of ETRANGUIAS_GuiaTransportistasDetalle)
    '        Try
    ...
    '                    m_ETRANGUIAS_GuiaTransportistasDetalle.ListDetPedidos = New List(Of ETRANGUIAS_GuiaTransportistasDetalleDetalle)(m_bvent_pedidosdetalle.ListVENT_PedidosDetalle)
    '                End If
    '                Return True
    '            Else
    '                Return False
    ...
    '        Try
    '            For Each item As ETRANGUIAS_GuiaTransportistasDetalle In m_listVENT_Pedidos
