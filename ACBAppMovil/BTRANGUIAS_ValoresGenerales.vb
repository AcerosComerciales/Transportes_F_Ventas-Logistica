...
Public Class BTRANGUIAS_ValoresGenerales

    '    Private m_ETRANGUIAS_ValoresGenerales As ETRANGUIAS_ValoresGenerales
    '    Private m_listVENT_Pedidos As List(Of ETRANGUIAS_ValoresGenerales)
    '    Private m_dtVENT_Pedidos As DataTable

    '    Private m_dsVENT_Pedidos As DataSet
    '    Private d_vent_pedidos As DTRANGUIAS_ValoresGenerales
    ...
    '        m_listVENT_Pedidos = New List(Of ETRANGUIAS_ValoresGenerales)
    '        Try
    ...
    '                    m_ETRANGUIAS_ValoresGenerales.ListDetPedidos = New List(Of ETRANGUIAS_ValoresGeneralesDetalle)(m_bvent_pedidosdetalle.ListVENT_PedidosDetalle)
    '                End If
    '                Return True
    '            Else
    '                Return False
    ...
    '        Try
    '            For Each item As ETRANGUIAS_ValoresGenerales In m_listVENT_Pedidos
