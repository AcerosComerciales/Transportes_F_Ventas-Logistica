...
Public Class BTRANGUIAS_GuiaTransportistasPlacas
    '#Region "Variables"
    '    Private m_ETRANGUIAS_GuiaTransportistasPlacas As ETRANGUIAS_GuiaTransportistasPlacas
    '    Private m_listVENT_Pedidos As List(Of ETRANGUIAS_GuiaTransportistasPlacas)
    '    Private m_dtVENT_Pedidos As DataTable

    '    Private m_dsVENT_Pedidos As DataSet
    '    Private d_vent_pedidos As DTRANGUIAS_GuiaTransportistasPlacas
    ...
    '        m_listVENT_Pedidos = New List(Of ETRANGUIAS_GuiaTransportistasPlacas)
    '        Try
    ...
    '                    m_ETRANGUIAS_GuiaTransportistasPlacas.ListDetPedidos = New List(Of ETRANGUIAS_GuiaTransportistasPlacasDetalle)(m_bvent_pedidosdetalle.ListVENT_PedidosDetalle)
    '                End If
    '                Return True
    '            Else
    '                Return False
    ...
    '        Try
    '            For Each item As ETRANGUIAS_GuiaTransportistasPlacas In m_listVENT_Pedidos
