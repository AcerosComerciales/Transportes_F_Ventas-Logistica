...
Public Class BTRANGUIAS_TiposGenerales
    '#Region "Variables"
    '    Private m_ETRANGUIAS_TiposGenerales As ETRANGUIAS_TiposGenerales
    '    Private m_listVENT_Pedidos As List(Of ETRANGUIAS_TiposGenerales)
    '    Private m_dtVENT_Pedidos As DataTable

    '    Private m_dsVENT_Pedidos As DataSet
    '    Private d_vent_pedidos As DTRANGUIAS_TiposGenerales
    ...
    '        m_listVENT_Pedidos = New List(Of ETRANGUIAS_TiposGenerales)
    '        Try
    ...
    '                    m_ETRANGUIAS_TiposGenerales.ListDetPedidos = New List(Of ETRANGUIAS_TiposGeneralesDetalle)(m_bvent_pedidosdetalle.ListVENT_PedidosDetalle)
    '                End If
    '                Return True
    '            Else
    '                Return False
    ...
    '        Try
    '            For Each item As ETRANGUIAS_TiposGenerales In m_listVENT_Pedidos
